...
for.end:                                          ; preds = %for.cond
  ...
  %cmp237 = icmp uge i32 %108, 0, !dbg !662
  %or.cond = and i1 %cmp236, %cmp237, !dbg !663
  %109 = load i32, i32* %op_type, align 4, !dbg !664
  %cmp239 = icmp ule i32 %109, 3, !dbg !665
  %or.cond1 = and i1 %or.cond, %cmp239, !dbg !663
  br i1 %or.cond1, label %if.then, label %if.end, !dbg !663

if.then:                                          ; preds = %for.end
  call void @llvm.dbg.declare(metadata i32* %i240, metadata !666, metadata !DIExpression()), !dbg !669
  store i32 0, i32* %i240, align 4, !dbg !669
  br label %for.cond241, !dbg !670

for.cond241:                                      ; preds = %for.body243, %if.then
  %110 = load i32, i32* %i240, align 4, !dbg !671
  %cmp242 = icmp slt i32 %110, 9, !dbg !673
  br i1 %cmp242, label %for.body243, label %for.end249, !dbg !674

for.body243:                                      ; preds = %for.cond241
  %111 = load i32, i32* %i240, align 4, !dbg !675
  %idxprom244 = sext i32 %111 to i64, !dbg !677
  %arrayidx245 = getelementptr inbounds [9 x %struct.INSTR], [9 x %struct.INSTR]* %microop, i64 0, i64 %idxprom244, !dbg !677
  %112 = bitcast %struct.INSTR* %agg.tmp to i8*, !dbg !677
  %113 = bitcast %struct.INSTR* %arrayidx245 to i8*, !dbg !677
  %114 = call i8* @memcpy(i8* %112, i8* %113, i64 40), !dbg !677
  %call246 = call i32* @_Z13micro_decoder5INSTR(%struct.INSTR* byval(%struct.INSTR) align 8 %agg.tmp), !dbg !678
  store i32* %call246, i32** %acc_mem_ref, align 8, !dbg !679
  %115 = load i32, i32* %i240, align 4, !dbg !680
  %inc248 = add nsw i32 %115, 1, !dbg !680
  store i32 %inc248, i32* %i240, align 4, !dbg !680
  br label %for.cond241, !dbg !681, !llvm.loop !682

for.end249:                                       ; preds = %for.cond241
  call void @llvm.dbg.declare(metadata i32* %i250, metadata !684, metadata !DIExpression()), !dbg !686
  store i32 0, i32* %i250, align 4, !dbg !686
  br label %for.cond251, !dbg !687

for.cond251:                                      ; preds = %for.body253, %for.end249
  %116 = load i32, i32* %i250, align 4, !dbg !688
  %cmp252 = icmp slt i32 %116, 9, !dbg !690
  br i1 %cmp252, label %for.body253, label %for.end260, !dbg !691

for.body253:                                      ; preds = %for.cond251
  %117 = load i32, i32* %i250, align 4, !dbg !692
  %idxprom255 = sext i32 %117 to i64, !dbg !694
  %arrayidx256 = getelementptr inbounds [9 x %struct.INSTR_VAL], [9 x %struct.INSTR_VAL]* %microop_val, i64 0, i64 %idxprom255, !dbg !694
  %118 = bitcast %struct.INSTR_VAL* %agg.tmp254 to i8*, !dbg !694
  %119 = bitcast %struct.INSTR_VAL* %arrayidx256 to i8*, !dbg !694
  %120 = call i8* @memcpy(i8* %118, i8* %119, i64 24), !dbg !694
  %call257 = call i32* @_Z17micro_decoder_val9INSTR_VAL(%struct.INSTR_VAL* byval(%struct.INSTR_VAL) align 8 %agg.tmp254), !dbg !695
  store i32* %call257, i32** %acc_mem_val, align 8, !dbg !696
  %121 = load i32, i32* %i250, align 4, !dbg !697
  %inc259 = add nsw i32 %121, 1, !dbg !697
  store i32 %inc259, i32* %i250, align 4, !dbg !697
  br label %for.cond251, !dbg !698, !llvm.loop !699

for.end260:                                       ; preds = %for.cond251
  call void @llvm.dbg.declare(metadata i32* %i261, metadata !701, metadata !DIExpression()), !dbg !703
  store i32 0, i32* %i261, align 4, !dbg !703
  br label %for.cond262, !dbg !704

for.cond262:                                      ; preds = %for.inc270, %for.end260
  %122 = load i32, i32* %i261, align 4, !dbg !705
  %cmp263 = icmp slt i32 %122, 9, !dbg !707
  br i1 %cmp263, label %for.body264, label %if.end, !dbg !708

for.body264:                                      ; preds = %for.cond262
  %123 = load i32*, i32** %acc_mem_gemm, align 8, !dbg !709
  %124 = load i32, i32* %i261, align 4, !dbg !709
  %idxprom265 = sext i32 %124 to i64, !dbg !709
  %arrayidx266 = getelementptr inbounds i32, i32* %123, i64 %idxprom265, !dbg !709
  %125 = load i32, i32* %arrayidx266, align 4, !dbg !709
  %126 = load i32*, i32** %acc_mem_ref, align 8, !dbg !709
  %127 = load i32, i32* %i261, align 4, !dbg !709
  %idxprom267 = sext i32 %127 to i64, !dbg !709
  %arrayidx268 = getelementptr inbounds i32, i32* %126, i64 %idxprom267, !dbg !709
  %128 = load i32, i32* %arrayidx268, align 4, !dbg !709
  %cmp269 = icmp eq i32 %125, %128, !dbg !709
  br i1 %cmp269, label %for.inc270, label %cond.false, !dbg !709

cond.false:                                       ; preds = %for.body264
  call void @__assert_fail(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 159, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !709
  unreachable, !dbg !709

for.inc270:                                       ; preds = %for.body264
  %129 = load i32, i32* %i261, align 4, !dbg !711
  %inc271 = add nsw i32 %129, 1, !dbg !711
  store i32 %inc271, i32* %i261, align 4, !dbg !711
  br label %for.cond262, !dbg !712, !llvm.loop !713
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !716 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !722, metadata !DIExpression()), !dbg !723
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !724, metadata !DIExpression()), !dbg !725
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !726, metadata !DIExpression()), !dbg !727
  call void @llvm.dbg.declare(metadata i8** %7, metadata !728, metadata !DIExpression()), !dbg !729
  %9 = load i8*, i8** %4, align 8, !dbg !730
  store i8* %9, i8** %7, align 8, !dbg !729
  call void @llvm.dbg.declare(metadata i8** %8, metadata !731, metadata !DIExpression()), !dbg !732
  %10 = load i8*, i8** %5, align 8, !dbg !733
  store i8* %10, i8** %8, align 8, !dbg !732
  br label %11, !dbg !734

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !735
  %13 = add i64 %12, -1, !dbg !735
  store i64 %13, i64* %6, align 8, !dbg !735
  %14 = icmp ugt i64 %12, 0, !dbg !736
  br i1 %14, label %15, label %21, !dbg !734

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !737
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !737
  store i8* %17, i8** %8, align 8, !dbg !737
  %18 = load i8, i8* %16, align 1, !dbg !738
  %19 = load i8*, i8** %7, align 8, !dbg !739
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !739
  store i8* %20, i8** %7, align 8, !dbg !739
  store i8 %18, i8* %19, align 1, !dbg !740
  br label %11, !dbg !734, !llvm.loop !741

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !742
  ret i8* %22, !dbg !743
}
...
!493 = !DILocation(line: 100, column: 25, scope: !458)
...
!658 = !DILocation(line: 149, column: 10, scope: !659)
!659 = distinct !DILexicalBlock(scope: !458, file: !3, line: 149, column: 9)
!660 = !DILocation(line: 149, column: 17, scope: !659)
...
!664 = !DILocation(line: 149, column: 45, scope: !659)
!665 = !DILocation(line: 149, column: 52, scope: !659)
!666 = !DILocalVariable(name: "i", scope: !667, file: !3, line: 150, type: !38)
!667 = distinct !DILexicalBlock(scope: !668, file: !3, line: 150, column: 9)
!668 = distinct !DILexicalBlock(scope: !659, file: !3, line: 149, column: 58)
!669 = !DILocation(line: 150, column: 18, scope: !667)
!670 = !DILocation(line: 150, column: 14, scope: !667)
!671 = !DILocation(line: 150, column: 22, scope: !672)
!672 = distinct !DILexicalBlock(scope: !667, file: !3, line: 150, column: 9)
!673 = !DILocation(line: 150, column: 23, scope: !672)
!674 = !DILocation(line: 150, column: 9, scope: !667)
!675 = !DILocation(line: 151, column: 49, scope: !676)
!676 = distinct !DILexicalBlock(scope: !672, file: !3, line: 150, column: 30)
!677 = !DILocation(line: 151, column: 41, scope: !676)
!678 = !DILocation(line: 151, column: 27, scope: !676)
!679 = !DILocation(line: 151, column: 25, scope: !676)
!680 = !DILocation(line: 150, column: 27, scope: !672)
!681 = !DILocation(line: 150, column: 9, scope: !672)
!682 = distinct !{!682, !674, !683}
!683 = !DILocation(line: 153, column: 13, scope: !667)
!684 = !DILocalVariable(name: "i", scope: !685, file: !3, line: 154, type: !38)
!685 = distinct !DILexicalBlock(scope: !668, file: !3, line: 154, column: 9)
!686 = !DILocation(line: 154, column: 18, scope: !685)
!687 = !DILocation(line: 154, column: 14, scope: !685)
!688 = !DILocation(line: 154, column: 22, scope: !689)
!689 = distinct !DILexicalBlock(scope: !685, file: !3, line: 154, column: 9)
!690 = !DILocation(line: 154, column: 23, scope: !689)
!691 = !DILocation(line: 154, column: 9, scope: !685)
!692 = !DILocation(line: 155, column: 57, scope: !693)
!693 = distinct !DILexicalBlock(scope: !689, file: !3, line: 154, column: 30)
!694 = !DILocation(line: 155, column: 45, scope: !693)
!695 = !DILocation(line: 155, column: 27, scope: !693)
!696 = !DILocation(line: 155, column: 25, scope: !693)
!697 = !DILocation(line: 154, column: 27, scope: !689)
!698 = !DILocation(line: 154, column: 9, scope: !689)
!699 = distinct !{!699, !691, !700}
!700 = !DILocation(line: 157, column: 13, scope: !685)
!701 = !DILocalVariable(name: "i", scope: !702, file: !3, line: 158, type: !38)
!702 = distinct !DILexicalBlock(scope: !668, file: !3, line: 158, column: 9)
!703 = !DILocation(line: 158, column: 18, scope: !702)
!704 = !DILocation(line: 158, column: 14, scope: !702)
!705 = !DILocation(line: 158, column: 25, scope: !706)
!706 = distinct !DILexicalBlock(scope: !702, file: !3, line: 158, column: 9)
!707 = !DILocation(line: 158, column: 27, scope: !706)
!708 = !DILocation(line: 158, column: 9, scope: !702)
!709 = !DILocation(line: 159, column: 10, scope: !710)
!710 = distinct !DILexicalBlock(scope: !706, file: !3, line: 158, column: 43)
!711 = !DILocation(line: 158, column: 39, scope: !706)
!712 = !DILocation(line: 158, column: 9, scope: !706)
!713 = distinct !{!713, !708, !714}
!714 = !DILocation(line: 160, column: 13, scope: !702)
!715 = !DILocation(line: 166, column: 1, scope: !458)
!716 = distinct !DISubprogram(name: "memcpy", scope: !717, file: !717, line: 12, type: !718, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !125, retainedNodes: !4)
!717 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!718 = !DISubroutineType(types: !719)
!719 = !{!35, !35, !36, !720}
!720 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !721, line: 46, baseType: !41)
!721 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!722 = !DILocalVariable(name: "destaddr", arg: 1, scope: !716, file: !717, line: 12, type: !35)
!723 = !DILocation(line: 12, column: 20, scope: !716)
!724 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !716, file: !717, line: 12, type: !36)
!725 = !DILocation(line: 12, column: 42, scope: !716)
!726 = !DILocalVariable(name: "len", arg: 3, scope: !716, file: !717, line: 12, type: !720)
!727 = !DILocation(line: 12, column: 58, scope: !716)
!728 = !DILocalVariable(name: "dest", scope: !716, file: !717, line: 13, type: !65)
!729 = !DILocation(line: 13, column: 9, scope: !716)
!730 = !DILocation(line: 13, column: 16, scope: !716)
!731 = !DILocalVariable(name: "src", scope: !716, file: !717, line: 14, type: !69)
!732 = !DILocation(line: 14, column: 15, scope: !716)
!733 = !DILocation(line: 14, column: 21, scope: !716)
!734 = !DILocation(line: 16, column: 3, scope: !716)
!735 = !DILocation(line: 16, column: 13, scope: !716)
!736 = !DILocation(line: 16, column: 16, scope: !716)
!737 = !DILocation(line: 17, column: 19, scope: !716)
!738 = !DILocation(line: 17, column: 15, scope: !716)
!739 = !DILocation(line: 17, column: 10, scope: !716)
!740 = !DILocation(line: 17, column: 13, scope: !716)
!741 = distinct !{!741, !734, !737}
!742 = !DILocation(line: 18, column: 10, scope: !716)
!743 = !DILocation(line: 18, column: 3, scope: !716)
