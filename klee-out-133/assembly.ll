...
for.cond280:                                      ; preds = %for.inc291, %if.end
  ...
  br i1 %cmp281, label %for.body282, label %for.end293, !dbg !730
...
cond.false289:                                    ; preds = %for.body282
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 170, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !731
  unreachable, !dbg !731
...
!723 = !DILocalVariable(name: "i", scope: !724, file: !3, line: 169, type: !38)
!724 = distinct !DILexicalBlock(scope: !458, file: !3, line: 169, column: 6)
!725 = !DILocation(line: 169, column: 15, scope: !724)
!726 = !DILocation(line: 169, column: 11, scope: !724)
!727 = !DILocation(line: 169, column: 22, scope: !728)
!728 = distinct !DILexicalBlock(scope: !724, file: !3, line: 169, column: 6)
!729 = !DILocation(line: 169, column: 24, scope: !728)
!730 = !DILocation(line: 169, column: 6, scope: !724)
!731 = !DILocation(line: 170, column: 17, scope: !732)
!732 = distinct !DILexicalBlock(scope: !728, file: !3, line: 169, column: 40)
!733 = !DILocation(line: 169, column: 36, scope: !728)
!734 = !DILocation(line: 169, column: 6, scope: !728)
!735 = distinct !{!735, !730, !736}
!736 = !DILocation(line: 171, column: 17, scope: !724)
!737 = !DILocation(line: 172, column: 1, scope: !458)
