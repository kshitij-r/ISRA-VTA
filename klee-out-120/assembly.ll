...
@.str.2 = private unnamed_addr constant [34 x i8] c"acc_mem_gemm[i] == acc_mem_val[i]\00", align 1
...
entry:
  ...
  %agg.tmp258 = alloca %struct.INSTR_VAL, align 8
...
for.cond245:                                      ; preds = %for.body247, %if.then
  ...
  br i1 %cmp246, label %for.body247, label %for.end253, !dbg !666
...
for.body247:                                      ; preds = %for.cond245
  ...
  %120 = load i32, i32* %i244, align 4, !dbg !672
  %inc252 = add nsw i32 %120, 1, !dbg !672
  store i32 %inc252, i32* %i244, align 4, !dbg !672
  br label %for.cond245, !dbg !673, !llvm.loop !674

for.end253:                                       ; preds = %for.cond245
  call void @llvm.dbg.declare(metadata i32* %i254, metadata !676, metadata !DIExpression()), !dbg !678
  store i32 0, i32* %i254, align 4, !dbg !678
  br label %for.cond255, !dbg !679

for.cond255:                                      ; preds = %for.body257, %for.end253
  %121 = load i32, i32* %i254, align 4, !dbg !680
  %cmp256 = icmp slt i32 %121, 9, !dbg !682
  br i1 %cmp256, label %for.body257, label %for.end264, !dbg !683

for.body257:                                      ; preds = %for.cond255
  %122 = load i32, i32* %i254, align 4, !dbg !684
  %idxprom259 = sext i32 %122 to i64, !dbg !686
  %arrayidx260 = getelementptr inbounds [9 x %struct.INSTR_VAL], [9 x %struct.INSTR_VAL]* %microop_val, i64 0, i64 %idxprom259, !dbg !686
  %123 = bitcast %struct.INSTR_VAL* %agg.tmp258 to i8*, !dbg !686
  %124 = bitcast %struct.INSTR_VAL* %arrayidx260 to i8*, !dbg !686
  %125 = call i8* @memcpy(i8* %123, i8* %124, i64 24), !dbg !686
  %call261 = call i32* @_Z17micro_decoder_val9INSTR_VAL(%struct.INSTR_VAL* byval(%struct.INSTR_VAL) align 8 %agg.tmp258), !dbg !687
  store i32* %call261, i32** %acc_mem_val, align 8, !dbg !688
  %126 = load i32, i32* %i254, align 4, !dbg !689
  %inc263 = add nsw i32 %126, 1, !dbg !689
  store i32 %inc263, i32* %i254, align 4, !dbg !689
  br label %for.cond255, !dbg !690, !llvm.loop !691

for.end264:                                       ; preds = %for.cond255
  call void @llvm.dbg.declare(metadata i32* %i265, metadata !693, metadata !DIExpression()), !dbg !695
  store i32 0, i32* %i265, align 4, !dbg !695
  br label %for.cond266, !dbg !696

for.cond266:                                      ; preds = %for.inc274, %for.end264
  %127 = load i32, i32* %i265, align 4, !dbg !697
  %cmp267 = icmp slt i32 %127, 9, !dbg !699
  br i1 %cmp267, label %for.body268, label %if.end, !dbg !700

for.body268:                                      ; preds = %for.cond266
  %128 = load i32*, i32** %acc_mem_gemm, align 8, !dbg !701
  %129 = load i32, i32* %i265, align 4, !dbg !701
  %idxprom269 = sext i32 %129 to i64, !dbg !701
  %arrayidx270 = getelementptr inbounds i32, i32* %128, i64 %idxprom269, !dbg !701
  %130 = load i32, i32* %arrayidx270, align 4, !dbg !701
  %131 = load i32*, i32** %acc_mem_val, align 8, !dbg !701
  %132 = load i32, i32* %i265, align 4, !dbg !701
  %idxprom271 = sext i32 %132 to i64, !dbg !701
  %arrayidx272 = getelementptr inbounds i32, i32* %131, i64 %idxprom271, !dbg !701
  %133 = load i32, i32* %arrayidx272, align 4, !dbg !701
  %cmp273 = icmp eq i32 %130, %133, !dbg !701
  br i1 %cmp273, label %for.inc274, label %cond.false, !dbg !701

cond.false:                                       ; preds = %for.body268
  call void @__assert_fail(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 156, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !701
  unreachable, !dbg !701

for.inc274:                                       ; preds = %for.body268
  %134 = load i32, i32* %i265, align 4, !dbg !703
  %inc275 = add nsw i32 %134, 1, !dbg !703
  store i32 %inc275, i32* %i265, align 4, !dbg !703
  br label %for.cond266, !dbg !704, !llvm.loop !705

if.end:                                           ; preds = %for.cond266, %for.end
  ret i32 0, !dbg !707
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !708 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !714, metadata !DIExpression()), !dbg !715
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !716, metadata !DIExpression()), !dbg !717
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !718, metadata !DIExpression()), !dbg !719
  call void @llvm.dbg.declare(metadata i8** %7, metadata !720, metadata !DIExpression()), !dbg !721
  %9 = load i8*, i8** %4, align 8, !dbg !722
  store i8* %9, i8** %7, align 8, !dbg !721
  call void @llvm.dbg.declare(metadata i8** %8, metadata !723, metadata !DIExpression()), !dbg !724
  %10 = load i8*, i8** %5, align 8, !dbg !725
  store i8* %10, i8** %8, align 8, !dbg !724
  br label %11, !dbg !726

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !727
  %13 = add i64 %12, -1, !dbg !727
  store i64 %13, i64* %6, align 8, !dbg !727
  %14 = icmp ugt i64 %12, 0, !dbg !728
  br i1 %14, label %15, label %21, !dbg !726

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !729
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !729
  store i8* %17, i8** %8, align 8, !dbg !729
  %18 = load i8, i8* %16, align 1, !dbg !730
  %19 = load i8*, i8** %7, align 8, !dbg !731
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !731
  store i8* %20, i8** %7, align 8, !dbg !731
  store i8 %18, i8* %19, align 1, !dbg !732
  br label %11, !dbg !726, !llvm.loop !733

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !734
  ret i8* %22, !dbg !735
}
...
!672 = !DILocation(line: 144, column: 27, scope: !664)
!673 = !DILocation(line: 144, column: 9, scope: !664)
!674 = distinct !{!674, !666, !675}
!675 = !DILocation(line: 147, column: 13, scope: !659)
!676 = !DILocalVariable(name: "i", scope: !677, file: !3, line: 148, type: !40)
!677 = distinct !DILexicalBlock(scope: !660, file: !3, line: 148, column: 9)
!678 = !DILocation(line: 148, column: 18, scope: !677)
!679 = !DILocation(line: 148, column: 14, scope: !677)
!680 = !DILocation(line: 148, column: 22, scope: !681)
!681 = distinct !DILexicalBlock(scope: !677, file: !3, line: 148, column: 9)
!682 = !DILocation(line: 148, column: 23, scope: !681)
!683 = !DILocation(line: 148, column: 9, scope: !677)
!684 = !DILocation(line: 149, column: 57, scope: !685)
!685 = distinct !DILexicalBlock(scope: !681, file: !3, line: 148, column: 30)
!686 = !DILocation(line: 149, column: 45, scope: !685)
!687 = !DILocation(line: 149, column: 27, scope: !685)
!688 = !DILocation(line: 149, column: 25, scope: !685)
!689 = !DILocation(line: 148, column: 27, scope: !681)
!690 = !DILocation(line: 148, column: 9, scope: !681)
!691 = distinct !{!691, !683, !692}
!692 = !DILocation(line: 151, column: 13, scope: !677)
!693 = !DILocalVariable(name: "i", scope: !694, file: !3, line: 155, type: !40)
!694 = distinct !DILexicalBlock(scope: !660, file: !3, line: 155, column: 9)
!695 = !DILocation(line: 155, column: 18, scope: !694)
!696 = !DILocation(line: 155, column: 14, scope: !694)
!697 = !DILocation(line: 155, column: 25, scope: !698)
!698 = distinct !DILexicalBlock(scope: !694, file: !3, line: 155, column: 9)
!699 = !DILocation(line: 155, column: 27, scope: !698)
!700 = !DILocation(line: 155, column: 9, scope: !694)
!701 = !DILocation(line: 156, column: 10, scope: !702)
!702 = distinct !DILexicalBlock(scope: !698, file: !3, line: 155, column: 43)
!703 = !DILocation(line: 155, column: 39, scope: !698)
!704 = !DILocation(line: 155, column: 9, scope: !698)
!705 = distinct !{!705, !700, !706}
!706 = !DILocation(line: 157, column: 13, scope: !694)
!707 = !DILocation(line: 160, column: 1, scope: !444)
!708 = distinct !DISubprogram(name: "memcpy", scope: !709, file: !709, line: 12, type: !710, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !127, retainedNodes: !4)
!709 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!710 = !DISubroutineType(types: !711)
!711 = !{!37, !37, !38, !712}
!712 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !713, line: 46, baseType: !43)
!713 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!714 = !DILocalVariable(name: "destaddr", arg: 1, scope: !708, file: !709, line: 12, type: !37)
!715 = !DILocation(line: 12, column: 20, scope: !708)
!716 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !708, file: !709, line: 12, type: !38)
!717 = !DILocation(line: 12, column: 42, scope: !708)
!718 = !DILocalVariable(name: "len", arg: 3, scope: !708, file: !709, line: 12, type: !712)
!719 = !DILocation(line: 12, column: 58, scope: !708)
!720 = !DILocalVariable(name: "dest", scope: !708, file: !709, line: 13, type: !67)
!721 = !DILocation(line: 13, column: 9, scope: !708)
!722 = !DILocation(line: 13, column: 16, scope: !708)
!723 = !DILocalVariable(name: "src", scope: !708, file: !709, line: 14, type: !71)
!724 = !DILocation(line: 14, column: 15, scope: !708)
!725 = !DILocation(line: 14, column: 21, scope: !708)
!726 = !DILocation(line: 16, column: 3, scope: !708)
!727 = !DILocation(line: 16, column: 13, scope: !708)
!728 = !DILocation(line: 16, column: 16, scope: !708)
!729 = !DILocation(line: 17, column: 19, scope: !708)
!730 = !DILocation(line: 17, column: 15, scope: !708)
!731 = !DILocation(line: 17, column: 10, scope: !708)
!732 = !DILocation(line: 17, column: 13, scope: !708)
!733 = distinct !{!733, !726, !729}
!734 = !DILocation(line: 18, column: 10, scope: !708)
!735 = !DILocation(line: 18, column: 3, scope: !708)
