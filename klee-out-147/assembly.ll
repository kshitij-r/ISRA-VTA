...
for.cond273:                                      ; preds = %for.inc281, %for.end271
  ...
  br i1 %cmp274, label %for.body275, label %for.end283, !dbg !838

for.body275:                                      ; preds = %for.cond273
  %138 = load i32, i32* %i272, align 4, !dbg !839
  %idxprom276 = sext i32 %138 to i64, !dbg !841
  %arrayidx277 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage2, i64 0, i64 %idxprom276, !dbg !841
  %139 = load i32, i32* %arrayidx277, align 4, !dbg !841
  %140 = load i32, i32* %i272, align 4, !dbg !842
  %idxprom278 = sext i32 %140 to i64, !dbg !843
  %arrayidx279 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage3, i64 0, i64 %idxprom278, !dbg !843
  %141 = load i32, i32* %arrayidx279, align 4, !dbg !843
  %cmp280 = icmp eq i32 %139, %141, !dbg !844
  br i1 %cmp280, label %for.inc281, label %cond.false, !dbg !845

cond.false:                                       ; preds = %for.body275
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 192, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !846
  unreachable, !dbg !846

for.inc281:                                       ; preds = %for.body275
  %142 = load i32, i32* %i272, align 4, !dbg !847
  %inc282 = add nsw i32 %142, 1, !dbg !847
  store i32 %inc282, i32* %i272, align 4, !dbg !847
  br label %for.cond273, !dbg !848, !llvm.loop !849

for.end283:                                       ; preds = %for.cond273
  call void @llvm.dbg.declare(metadata i32* %i284, metadata !851, metadata !DIExpression()), !dbg !853
  store i32 0, i32* %i284, align 4, !dbg !853
  br label %for.cond285, !dbg !854

for.cond285:                                      ; preds = %for.inc296, %for.end283
  %143 = load i32, i32* %i284, align 4, !dbg !855
  %cmp286 = icmp slt i32 %143, 9, !dbg !857
  br i1 %cmp286, label %for.body287, label %if.end, !dbg !858

for.body287:                                      ; preds = %for.cond285
  %144 = load i32, i32* %i284, align 4, !dbg !859
  %idxprom288 = sext i32 %144 to i64, !dbg !861
  %arrayidx289 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage2, i64 0, i64 %idxprom288, !dbg !861
  %145 = load i32, i32* %arrayidx289, align 4, !dbg !861
  %146 = load i32, i32* %i284, align 4, !dbg !862
  %idxprom290 = sext i32 %146 to i64, !dbg !863
  %arrayidx291 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage1, i64 0, i64 %idxprom290, !dbg !863
  %147 = load i32, i32* %arrayidx291, align 4, !dbg !863
  %cmp292 = icmp eq i32 %145, %147, !dbg !864
  br i1 %cmp292, label %for.inc296, label %cond.false294, !dbg !865

cond.false294:                                    ; preds = %for.body287
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 195, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !866
  unreachable, !dbg !866

for.inc296:                                       ; preds = %for.body287
  %148 = load i32, i32* %i284, align 4, !dbg !867
  %inc297 = add nsw i32 %148, 1, !dbg !867
  store i32 %inc297, i32* %i284, align 4, !dbg !867
  br label %for.cond285, !dbg !868, !llvm.loop !869
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !872 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !878, metadata !DIExpression()), !dbg !879
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !880, metadata !DIExpression()), !dbg !881
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !882, metadata !DIExpression()), !dbg !883
  call void @llvm.dbg.declare(metadata i8** %7, metadata !884, metadata !DIExpression()), !dbg !885
  %9 = load i8*, i8** %4, align 8, !dbg !886
  store i8* %9, i8** %7, align 8, !dbg !885
  call void @llvm.dbg.declare(metadata i8** %8, metadata !887, metadata !DIExpression()), !dbg !888
  %10 = load i8*, i8** %5, align 8, !dbg !889
  store i8* %10, i8** %8, align 8, !dbg !888
  br label %11, !dbg !890

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !891
  %13 = add i64 %12, -1, !dbg !891
  store i64 %13, i64* %6, align 8, !dbg !891
  %14 = icmp ugt i64 %12, 0, !dbg !892
  br i1 %14, label %15, label %21, !dbg !890

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !893
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !893
  store i8* %17, i8** %8, align 8, !dbg !893
  %18 = load i8, i8* %16, align 1, !dbg !894
  %19 = load i8*, i8** %7, align 8, !dbg !895
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !895
  store i8* %20, i8** %7, align 8, !dbg !895
  store i8 %18, i8* %19, align 1, !dbg !896
  br label %11, !dbg !890, !llvm.loop !897

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !898
  ret i8* %22, !dbg !899
}
...
!831 = !DILocalVariable(name: "i", scope: !832, file: !3, line: 191, type: !11)
!832 = distinct !DILexicalBlock(scope: !766, file: !3, line: 191, column: 9)
!833 = !DILocation(line: 191, column: 18, scope: !832)
!834 = !DILocation(line: 191, column: 14, scope: !832)
!835 = !DILocation(line: 191, column: 25, scope: !836)
!836 = distinct !DILexicalBlock(scope: !832, file: !3, line: 191, column: 9)
!837 = !DILocation(line: 191, column: 27, scope: !836)
!838 = !DILocation(line: 191, column: 9, scope: !832)
!839 = !DILocation(line: 192, column: 42, scope: !840)
!840 = distinct !DILexicalBlock(scope: !836, file: !3, line: 191, column: 43)
!841 = !DILocation(line: 192, column: 31, scope: !840)
!842 = !DILocation(line: 192, column: 59, scope: !840)
!843 = !DILocation(line: 192, column: 48, scope: !840)
!844 = !DILocation(line: 192, column: 45, scope: !840)
!845 = !DILocation(line: 192, column: 11, scope: !840)
!846 = !DILocation(line: 192, column: 76, scope: !840)
!847 = !DILocation(line: 191, column: 39, scope: !836)
!848 = !DILocation(line: 191, column: 9, scope: !836)
!849 = distinct !{!849, !838, !850}
!850 = !DILocation(line: 193, column: 13, scope: !832)
!851 = !DILocalVariable(name: "i", scope: !852, file: !3, line: 194, type: !11)
!852 = distinct !DILexicalBlock(scope: !766, file: !3, line: 194, column: 10)
!853 = !DILocation(line: 194, column: 19, scope: !852)
!854 = !DILocation(line: 194, column: 15, scope: !852)
!855 = !DILocation(line: 194, column: 26, scope: !856)
!856 = distinct !DILexicalBlock(scope: !852, file: !3, line: 194, column: 10)
!857 = !DILocation(line: 194, column: 28, scope: !856)
!858 = !DILocation(line: 194, column: 10, scope: !852)
!859 = !DILocation(line: 195, column: 42, scope: !860)
!860 = distinct !DILexicalBlock(scope: !856, file: !3, line: 194, column: 44)
!861 = !DILocation(line: 195, column: 31, scope: !860)
!862 = !DILocation(line: 195, column: 59, scope: !860)
!863 = !DILocation(line: 195, column: 48, scope: !860)
!864 = !DILocation(line: 195, column: 45, scope: !860)
!865 = !DILocation(line: 195, column: 11, scope: !860)
!866 = !DILocation(line: 195, column: 76, scope: !860)
!867 = !DILocation(line: 194, column: 40, scope: !856)
!868 = !DILocation(line: 194, column: 10, scope: !856)
!869 = distinct !{!869, !858, !870}
!870 = !DILocation(line: 196, column: 13, scope: !852)
!871 = !DILocation(line: 203, column: 1, scope: !573)
!872 = distinct !DISubprogram(name: "memcpy", scope: !873, file: !873, line: 12, type: !874, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !130, retainedNodes: !4)
!873 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!874 = !DISubroutineType(types: !875)
!875 = !{!41, !41, !42, !876}
!876 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !877, line: 46, baseType: !46)
!877 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!878 = !DILocalVariable(name: "destaddr", arg: 1, scope: !872, file: !873, line: 12, type: !41)
!879 = !DILocation(line: 12, column: 20, scope: !872)
!880 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !872, file: !873, line: 12, type: !42)
!881 = !DILocation(line: 12, column: 42, scope: !872)
!882 = !DILocalVariable(name: "len", arg: 3, scope: !872, file: !873, line: 12, type: !876)
!883 = !DILocation(line: 12, column: 58, scope: !872)
!884 = !DILocalVariable(name: "dest", scope: !872, file: !873, line: 13, type: !70)
!885 = !DILocation(line: 13, column: 9, scope: !872)
!886 = !DILocation(line: 13, column: 16, scope: !872)
!887 = !DILocalVariable(name: "src", scope: !872, file: !873, line: 14, type: !74)
!888 = !DILocation(line: 14, column: 15, scope: !872)
!889 = !DILocation(line: 14, column: 21, scope: !872)
!890 = !DILocation(line: 16, column: 3, scope: !872)
!891 = !DILocation(line: 16, column: 13, scope: !872)
!892 = !DILocation(line: 16, column: 16, scope: !872)
!893 = !DILocation(line: 17, column: 19, scope: !872)
!894 = !DILocation(line: 17, column: 15, scope: !872)
!895 = !DILocation(line: 17, column: 10, scope: !872)
!896 = !DILocation(line: 17, column: 13, scope: !872)
!897 = distinct !{!897, !890, !893}
!898 = !DILocation(line: 18, column: 10, scope: !872)
!899 = !DILocation(line: 18, column: 3, scope: !872)
