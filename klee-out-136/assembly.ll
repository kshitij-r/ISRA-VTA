...
for.body282:                                      ; preds = %for.cond280
  %136 = load i32, i32* %i279, align 4, !dbg !737
  %idxprom283 = sext i32 %136 to i64, !dbg !739
  %arrayidx284 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage2, i64 0, i64 %idxprom283, !dbg !739
  %137 = load i32, i32* %arrayidx284, align 4, !dbg !739
  %138 = load i32, i32* %i279, align 4, !dbg !740
  %idxprom285 = sext i32 %138 to i64, !dbg !741
  %arrayidx286 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage1, i64 0, i64 %idxprom285, !dbg !741
  %139 = load i32, i32* %arrayidx286, align 4, !dbg !741
  %cmp287 = icmp eq i32 %137, %139, !dbg !742
  br i1 %cmp287, label %for.inc291, label %cond.false289, !dbg !743

cond.false289:                                    ; preds = %for.body282
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 166, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !744
  unreachable, !dbg !744

for.inc291:                                       ; preds = %for.body282
  %140 = load i32, i32* %i279, align 4, !dbg !745
  %inc292 = add nsw i32 %140, 1, !dbg !745
...
!729 = !DILocalVariable(name: "i", scope: !730, file: !3, line: 165, type: !38)
!730 = distinct !DILexicalBlock(scope: !458, file: !3, line: 165, column: 5)
!731 = !DILocation(line: 165, column: 14, scope: !730)
!732 = !DILocation(line: 165, column: 10, scope: !730)
!733 = !DILocation(line: 165, column: 21, scope: !734)
!734 = distinct !DILexicalBlock(scope: !730, file: !3, line: 165, column: 5)
!735 = !DILocation(line: 165, column: 23, scope: !734)
!736 = !DILocation(line: 165, column: 5, scope: !730)
!737 = !DILocation(line: 166, column: 42, scope: !738)
!738 = distinct !DILexicalBlock(scope: !734, file: !3, line: 165, column: 39)
!739 = !DILocation(line: 166, column: 31, scope: !738)
!740 = !DILocation(line: 166, column: 59, scope: !738)
!741 = !DILocation(line: 166, column: 48, scope: !738)
!742 = !DILocation(line: 166, column: 45, scope: !738)
!743 = !DILocation(line: 166, column: 11, scope: !738)
!744 = !DILocation(line: 166, column: 76, scope: !738)
!745 = !DILocation(line: 165, column: 35, scope: !734)
!746 = !DILocation(line: 165, column: 5, scope: !734)
!747 = distinct !{!747, !736, !748}
!748 = !DILocation(line: 167, column: 13, scope: !730)
!749 = !DILocation(line: 169, column: 1, scope: !458)
