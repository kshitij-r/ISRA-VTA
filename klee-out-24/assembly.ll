...
define dso_local i32 @main() #2 !dbg !29 {
  ...
  %7 = load i32, i32* %3, align 4, !dbg !41
  call void @_Z6verifyii(i32 %6, i32 %7), !dbg !42
  ret i32 0, !dbg !43
}
...
!40 = !DILocation(line: 25, column: 10, scope: !29)
!41 = !DILocation(line: 25, column: 12, scope: !29)
!42 = !DILocation(line: 25, column: 3, scope: !29)
