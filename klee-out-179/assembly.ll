...
for.cond243:                                      ; preds = %for.body245, %for.end
  ...
  br i1 %cmp244, label %for.body245, label %for.end256, !dbg !690
...
for.end256:                                       ; preds = %for.cond243
  call void @llvm.dbg.declare(metadata i32* %i257, metadata !705, metadata !DIExpression()), !dbg !707
  store i32 0, i32* %i257, align 4, !dbg !707
  br label %for.cond258, !dbg !708

for.cond258:                                      ; preds = %for.body260, %for.end256
  %127 = load i32, i32* %i257, align 4, !dbg !709
  %cmp259 = icmp slt i32 %127, 9, !dbg !711
  br i1 %cmp259, label %for.body260, label %if.end, !dbg !712

for.body260:                                      ; preds = %for.cond258
  %128 = load i32, i32* %i257, align 4, !dbg !713
  %idxprom262 = sext i32 %128 to i64, !dbg !715
  %arrayidx263 = getelementptr inbounds [9 x %struct.INSTR_VAL], [9 x %struct.INSTR_VAL]* %microop_val, i64 0, i64 %idxprom262, !dbg !715
  %129 = bitcast %struct.INSTR_VAL* %agg.tmp261 to i8*, !dbg !715
  %130 = bitcast %struct.INSTR_VAL* %arrayidx263 to i8*, !dbg !715
  %131 = call i8* @memcpy(i8* %129, i8* %130, i64 24), !dbg !715
  %call264 = call i32* @_Z17micro_decoder_val9INSTR_VAL(%struct.INSTR_VAL* byval(%struct.INSTR_VAL) align 8 %agg.tmp261), !dbg !716
  store i32* %call264, i32** %acc_mem_val, align 8, !dbg !717
  %132 = load i32*, i32** %acc_mem_val, align 8, !dbg !718
  %133 = load i32, i32* %i257, align 4, !dbg !719
  %idxprom265 = sext i32 %133 to i64, !dbg !718
  %arrayidx266 = getelementptr inbounds i32, i32* %132, i64 %idxprom265, !dbg !718
  %134 = load i32, i32* %arrayidx266, align 4, !dbg !718
  %135 = load i32, i32* %i257, align 4, !dbg !720
  %idxprom267 = sext i32 %135 to i64, !dbg !721
  %arrayidx268 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage3, i64 0, i64 %idxprom267, !dbg !721
  store i32 %134, i32* %arrayidx268, align 4, !dbg !722
  %136 = load i32, i32* %i257, align 4, !dbg !723
  %inc270 = add nsw i32 %136, 1, !dbg !723
  store i32 %inc270, i32* %i257, align 4, !dbg !723
  br label %for.cond258, !dbg !724, !llvm.loop !725
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !728 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %7, metadata !740, metadata !DIExpression()), !dbg !741
  %9 = load i8*, i8** %4, align 8, !dbg !742
  store i8* %9, i8** %7, align 8, !dbg !741
  call void @llvm.dbg.declare(metadata i8** %8, metadata !743, metadata !DIExpression()), !dbg !744
  %10 = load i8*, i8** %5, align 8, !dbg !745
  store i8* %10, i8** %8, align 8, !dbg !744
  br label %11, !dbg !746

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !747
  %13 = add i64 %12, -1, !dbg !747
  store i64 %13, i64* %6, align 8, !dbg !747
  %14 = icmp ugt i64 %12, 0, !dbg !748
  br i1 %14, label %15, label %21, !dbg !746

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !749
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !749
  store i8* %17, i8** %8, align 8, !dbg !749
  %18 = load i8, i8* %16, align 1, !dbg !750
  %19 = load i8*, i8** %7, align 8, !dbg !751
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !751
  store i8* %20, i8** %7, align 8, !dbg !751
  store i8 %18, i8* %19, align 1, !dbg !752
  br label %11, !dbg !746, !llvm.loop !753

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !754
  ret i8* %22, !dbg !755
}
...
!705 = !DILocalVariable(name: "i", scope: !706, file: !3, line: 176, type: !15)
!706 = distinct !DILexicalBlock(scope: !662, file: !3, line: 176, column: 9)
!707 = !DILocation(line: 176, column: 18, scope: !706)
!708 = !DILocation(line: 176, column: 14, scope: !706)
!709 = !DILocation(line: 176, column: 22, scope: !710)
!710 = distinct !DILexicalBlock(scope: !706, file: !3, line: 176, column: 9)
!711 = !DILocation(line: 176, column: 23, scope: !710)
!712 = !DILocation(line: 176, column: 9, scope: !706)
!713 = !DILocation(line: 177, column: 57, scope: !714)
!714 = distinct !DILexicalBlock(scope: !710, file: !3, line: 176, column: 30)
!715 = !DILocation(line: 177, column: 45, scope: !714)
!716 = !DILocation(line: 177, column: 27, scope: !714)
!717 = !DILocation(line: 177, column: 25, scope: !714)
!718 = !DILocation(line: 178, column: 27, scope: !714)
!719 = !DILocation(line: 178, column: 39, scope: !714)
!720 = !DILocation(line: 178, column: 24, scope: !714)
!721 = !DILocation(line: 178, column: 13, scope: !714)
!722 = !DILocation(line: 178, column: 26, scope: !714)
!723 = !DILocation(line: 176, column: 27, scope: !710)
!724 = !DILocation(line: 176, column: 9, scope: !710)
!725 = distinct !{!725, !712, !726}
!726 = !DILocation(line: 179, column: 9, scope: !706)
!727 = !DILocation(line: 186, column: 5, scope: !469)
!728 = distinct !DISubprogram(name: "memcpy", scope: !729, file: !729, line: 12, type: !730, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !124, retainedNodes: !4)
!729 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!730 = !DISubroutineType(types: !731)
!731 = !{!38, !38, !39, !732}
!732 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !733, line: 46, baseType: !43)
!733 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!734 = !DILocalVariable(name: "destaddr", arg: 1, scope: !728, file: !729, line: 12, type: !38)
!735 = !DILocation(line: 12, column: 20, scope: !728)
!736 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !728, file: !729, line: 12, type: !39)
!737 = !DILocation(line: 12, column: 42, scope: !728)
!738 = !DILocalVariable(name: "len", arg: 3, scope: !728, file: !729, line: 12, type: !732)
!739 = !DILocation(line: 12, column: 58, scope: !728)
!740 = !DILocalVariable(name: "dest", scope: !728, file: !729, line: 13, type: !67)
!741 = !DILocation(line: 13, column: 9, scope: !728)
!742 = !DILocation(line: 13, column: 16, scope: !728)
!743 = !DILocalVariable(name: "src", scope: !728, file: !729, line: 14, type: !71)
!744 = !DILocation(line: 14, column: 15, scope: !728)
!745 = !DILocation(line: 14, column: 21, scope: !728)
!746 = !DILocation(line: 16, column: 3, scope: !728)
!747 = !DILocation(line: 16, column: 13, scope: !728)
!748 = !DILocation(line: 16, column: 16, scope: !728)
!749 = !DILocation(line: 17, column: 19, scope: !728)
!750 = !DILocation(line: 17, column: 15, scope: !728)
!751 = !DILocation(line: 17, column: 10, scope: !728)
!752 = !DILocation(line: 17, column: 13, scope: !728)
!753 = distinct !{!753, !746, !749}
!754 = !DILocation(line: 18, column: 10, scope: !728)
!755 = !DILocation(line: 18, column: 3, scope: !728)
