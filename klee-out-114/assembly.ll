...
for.cond244:                                      ; preds = %for.body246, %for.end
  ...
  br i1 %cmp245, label %for.body246, label %for.end257, !dbg !658

for.body246:                                      ; preds = %for.cond244
  %116 = load i32, i32* %i243, align 4, !dbg !659
  %idxprom248 = sext i32 %116 to i64, !dbg !661
  %arrayidx249 = getelementptr inbounds [9 x %struct.INSTR_VAL], [9 x %struct.INSTR_VAL]* %microop_val, i64 0, i64 %idxprom248, !dbg !661
  %117 = bitcast %struct.INSTR_VAL* %agg.tmp247 to i8*, !dbg !661
  %118 = bitcast %struct.INSTR_VAL* %arrayidx249 to i8*, !dbg !661
  %119 = call i8* @memcpy(i8* %117, i8* %118, i64 24), !dbg !661
  %call250 = call i32* @_Z17micro_decoder_val9INSTR_VAL(%struct.INSTR_VAL* byval(%struct.INSTR_VAL) align 8 %agg.tmp247), !dbg !662
  store i32* %call250, i32** %acc_mem_val, align 8, !dbg !663
  %120 = load i32*, i32** %acc_mem_val, align 8, !dbg !664
  %121 = load i32, i32* %i243, align 4, !dbg !665
  %idxprom251 = sext i32 %121 to i64, !dbg !664
  %arrayidx252 = getelementptr inbounds i32, i32* %120, i64 %idxprom251, !dbg !664
  %122 = load i32, i32* %arrayidx252, align 4, !dbg !664
  %123 = load i32, i32* %i243, align 4, !dbg !666
  %idxprom253 = sext i32 %123 to i64, !dbg !667
  %arrayidx254 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage3, i64 0, i64 %idxprom253, !dbg !667
  store i32 %122, i32* %arrayidx254, align 4, !dbg !668
  %124 = load i32, i32* %i243, align 4, !dbg !669
  %inc256 = add nsw i32 %124, 1, !dbg !669
  store i32 %inc256, i32* %i243, align 4, !dbg !669
  br label %for.cond244, !dbg !670, !llvm.loop !671

for.end257:                                       ; preds = %for.cond244
  call void @llvm.dbg.declare(metadata i32* %i258, metadata !673, metadata !DIExpression()), !dbg !675
  store i32 0, i32* %i258, align 4, !dbg !675
  br label %for.cond259, !dbg !676

for.cond259:                                      ; preds = %for.inc267, %for.end257
  %125 = load i32, i32* %i258, align 4, !dbg !677
  %cmp260 = icmp slt i32 %125, 9, !dbg !679
  br i1 %cmp260, label %for.body261, label %for.end269, !dbg !680

for.body261:                                      ; preds = %for.cond259
  %126 = load i32*, i32** %acc_mem_ref, align 8, !dbg !681
  %127 = load i32, i32* %i258, align 4, !dbg !681
  %idxprom262 = sext i32 %127 to i64, !dbg !681
  %arrayidx263 = getelementptr inbounds i32, i32* %126, i64 %idxprom262, !dbg !681
  %128 = load i32, i32* %arrayidx263, align 4, !dbg !681
  %129 = load i32*, i32** %acc_mem_gemm, align 8, !dbg !681
  %130 = load i32, i32* %i258, align 4, !dbg !681
  %idxprom264 = sext i32 %130 to i64, !dbg !681
  %arrayidx265 = getelementptr inbounds i32, i32* %129, i64 %idxprom264, !dbg !681
  %131 = load i32, i32* %arrayidx265, align 4, !dbg !681
  %cmp266 = icmp eq i32 %128, %131, !dbg !681
  br i1 %cmp266, label %for.inc267, label %cond.false, !dbg !681

cond.false:                                       ; preds = %for.body261
  call void @__assert_fail(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 151, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !681
  unreachable, !dbg !681

for.inc267:                                       ; preds = %for.body261
  %132 = load i32, i32* %i258, align 4, !dbg !683
  %inc268 = add nsw i32 %132, 1, !dbg !683
  store i32 %inc268, i32* %i258, align 4, !dbg !683
  br label %for.cond259, !dbg !684, !llvm.loop !685

for.end269:                                       ; preds = %for.cond259
  call void @llvm.dbg.declare(metadata i32* %i270, metadata !687, metadata !DIExpression()), !dbg !689
  store i32 0, i32* %i270, align 4, !dbg !689
  br label %for.cond271, !dbg !690

for.cond271:                                      ; preds = %for.inc282, %for.end269
  %133 = load i32, i32* %i270, align 4, !dbg !691
  %cmp272 = icmp slt i32 %133, 9, !dbg !693
  br i1 %cmp272, label %for.body273, label %if.end, !dbg !694

for.body273:                                      ; preds = %for.cond271
  %134 = load i32*, i32** %acc_mem_ref, align 8, !dbg !695
  %135 = load i32, i32* %i270, align 4, !dbg !695
  %idxprom274 = sext i32 %135 to i64, !dbg !695
  %arrayidx275 = getelementptr inbounds i32, i32* %134, i64 %idxprom274, !dbg !695
  %136 = load i32, i32* %arrayidx275, align 4, !dbg !695
  %137 = load i32*, i32** %acc_mem_val, align 8, !dbg !695
  %138 = load i32, i32* %i270, align 4, !dbg !695
  %idxprom276 = sext i32 %138 to i64, !dbg !695
  %arrayidx277 = getelementptr inbounds i32, i32* %137, i64 %idxprom276, !dbg !695
  %139 = load i32, i32* %arrayidx277, align 4, !dbg !695
  %cmp278 = icmp eq i32 %136, %139, !dbg !695
  br i1 %cmp278, label %for.inc282, label %cond.false280, !dbg !695

cond.false280:                                    ; preds = %for.body273
  call void @__assert_fail(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 154, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !695
  unreachable, !dbg !695

for.inc282:                                       ; preds = %for.body273
  %140 = load i32, i32* %i270, align 4, !dbg !697
  %inc283 = add nsw i32 %140, 1, !dbg !697
  store i32 %inc283, i32* %i270, align 4, !dbg !697
  br label %for.cond271, !dbg !698, !llvm.loop !699
...
!651 = !DILocalVariable(name: "i", scope: !652, file: !3, line: 146, type: !37)
!652 = distinct !DILexicalBlock(scope: !635, file: !3, line: 146, column: 9)
!653 = !DILocation(line: 146, column: 18, scope: !652)
!654 = !DILocation(line: 146, column: 14, scope: !652)
!655 = !DILocation(line: 146, column: 22, scope: !656)
!656 = distinct !DILexicalBlock(scope: !652, file: !3, line: 146, column: 9)
!657 = !DILocation(line: 146, column: 23, scope: !656)
!658 = !DILocation(line: 146, column: 9, scope: !652)
!659 = !DILocation(line: 147, column: 57, scope: !660)
!660 = distinct !DILexicalBlock(scope: !656, file: !3, line: 146, column: 30)
!661 = !DILocation(line: 147, column: 45, scope: !660)
!662 = !DILocation(line: 147, column: 27, scope: !660)
!663 = !DILocation(line: 147, column: 25, scope: !660)
!664 = !DILocation(line: 148, column: 27, scope: !660)
!665 = !DILocation(line: 148, column: 39, scope: !660)
!666 = !DILocation(line: 148, column: 24, scope: !660)
!667 = !DILocation(line: 148, column: 13, scope: !660)
!668 = !DILocation(line: 148, column: 26, scope: !660)
!669 = !DILocation(line: 146, column: 27, scope: !656)
!670 = !DILocation(line: 146, column: 9, scope: !656)
!671 = distinct !{!671, !658, !672}
!672 = !DILocation(line: 149, column: 13, scope: !652)
!673 = !DILocalVariable(name: "i", scope: !674, file: !3, line: 150, type: !37)
!674 = distinct !DILexicalBlock(scope: !635, file: !3, line: 150, column: 9)
!675 = !DILocation(line: 150, column: 18, scope: !674)
!676 = !DILocation(line: 150, column: 14, scope: !674)
!677 = !DILocation(line: 150, column: 25, scope: !678)
!678 = distinct !DILexicalBlock(scope: !674, file: !3, line: 150, column: 9)
!679 = !DILocation(line: 150, column: 27, scope: !678)
!680 = !DILocation(line: 150, column: 9, scope: !674)
!681 = !DILocation(line: 151, column: 10, scope: !682)
!682 = distinct !DILexicalBlock(scope: !678, file: !3, line: 150, column: 43)
!683 = !DILocation(line: 150, column: 39, scope: !678)
!684 = !DILocation(line: 150, column: 9, scope: !678)
!685 = distinct !{!685, !680, !686}
!686 = !DILocation(line: 152, column: 13, scope: !674)
!687 = !DILocalVariable(name: "i", scope: !688, file: !3, line: 153, type: !37)
!688 = distinct !DILexicalBlock(scope: !635, file: !3, line: 153, column: 9)
!689 = !DILocation(line: 153, column: 18, scope: !688)
!690 = !DILocation(line: 153, column: 14, scope: !688)
!691 = !DILocation(line: 153, column: 25, scope: !692)
!692 = distinct !DILexicalBlock(scope: !688, file: !3, line: 153, column: 9)
!693 = !DILocation(line: 153, column: 27, scope: !692)
!694 = !DILocation(line: 153, column: 9, scope: !688)
!695 = !DILocation(line: 154, column: 10, scope: !696)
!696 = distinct !DILexicalBlock(scope: !692, file: !3, line: 153, column: 43)
!697 = !DILocation(line: 153, column: 39, scope: !692)
!698 = !DILocation(line: 153, column: 9, scope: !692)
!699 = distinct !{!699, !694, !700}
!700 = !DILocation(line: 155, column: 13, scope: !688)
!701 = !DILocation(line: 158, column: 1, scope: !437)
!702 = distinct !DISubprogram(name: "memcpy", scope: !703, file: !703, line: 12, type: !704, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !121, retainedNodes: !4)
!703 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!704 = !DISubroutineType(types: !705)
!705 = !{!34, !34, !35, !706}
!706 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !707, line: 46, baseType: !40)
!707 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!708 = !DILocalVariable(name: "destaddr", arg: 1, scope: !702, file: !703, line: 12, type: !34)
!709 = !DILocation(line: 12, column: 20, scope: !702)
!710 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !702, file: !703, line: 12, type: !35)
...
!714 = !DILocalVariable(name: "dest", scope: !702, file: !703, line: 13, type: !64)
!715 = !DILocation(line: 13, column: 9, scope: !702)
!716 = !DILocation(line: 13, column: 16, scope: !702)
!717 = !DILocalVariable(name: "src", scope: !702, file: !703, line: 14, type: !68)
