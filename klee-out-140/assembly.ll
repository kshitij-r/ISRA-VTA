...
if.end:                                           ; preds = %for.cond268, %for.end
  %135 = load i32, i32* %opcode, align 4, !dbg !729
  %cmp279 = icmp eq i32 %135, 2, !dbg !731
  br i1 %cmp279, label %if.then280, label %if.end296, !dbg !732

if.then280:                                       ; preds = %if.end
  call void @llvm.dbg.declare(metadata i32* %i281, metadata !733, metadata !DIExpression()), !dbg !736
  store i32 0, i32* %i281, align 4, !dbg !736
  br label %for.cond282, !dbg !737

for.cond282:                                      ; preds = %for.inc293, %if.then280
  %136 = load i32, i32* %i281, align 4, !dbg !738
  %cmp283 = icmp slt i32 %136, 9, !dbg !740
  br i1 %cmp283, label %for.body284, label %if.end296, !dbg !741

for.body284:                                      ; preds = %for.cond282
  %137 = load i32, i32* %i281, align 4, !dbg !742
  %idxprom285 = sext i32 %137 to i64, !dbg !742
  %arrayidx286 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage1, i64 0, i64 %idxprom285, !dbg !742
  %138 = load i32, i32* %arrayidx286, align 4, !dbg !742
  %139 = load i32, i32* %i281, align 4, !dbg !742
  %idxprom287 = sext i32 %139 to i64, !dbg !742
  %arrayidx288 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage2, i64 0, i64 %idxprom287, !dbg !742
  %140 = load i32, i32* %arrayidx288, align 4, !dbg !742
  %cmp289 = icmp eq i32 %138, %140, !dbg !742
  br i1 %cmp289, label %for.inc293, label %cond.false291, !dbg !742

cond.false291:                                    ; preds = %for.body284
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 168, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !742
  unreachable, !dbg !742

for.inc293:                                       ; preds = %for.body284
  %141 = load i32, i32* %i281, align 4, !dbg !744
  %inc294 = add nsw i32 %141, 1, !dbg !744
  store i32 %inc294, i32* %i281, align 4, !dbg !744
  br label %for.cond282, !dbg !745, !llvm.loop !746

if.end296:                                        ; preds = %for.cond282, %if.end
  ret i32 0, !dbg !748
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !749 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
...
21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !775
  ret i8* %22, !dbg !776
}
...
!729 = !DILocation(line: 166, column: 8, scope: !730)
!730 = distinct !DILexicalBlock(scope: !458, file: !3, line: 166, column: 8)
!731 = !DILocation(line: 166, column: 15, scope: !730)
!732 = !DILocation(line: 166, column: 8, scope: !458)
!733 = !DILocalVariable(name: "i", scope: !734, file: !3, line: 167, type: !38)
!734 = distinct !DILexicalBlock(scope: !735, file: !3, line: 167, column: 5)
!735 = distinct !DILexicalBlock(scope: !730, file: !3, line: 166, column: 20)
!736 = !DILocation(line: 167, column: 14, scope: !734)
!737 = !DILocation(line: 167, column: 10, scope: !734)
!738 = !DILocation(line: 167, column: 21, scope: !739)
!739 = distinct !DILexicalBlock(scope: !734, file: !3, line: 167, column: 5)
!740 = !DILocation(line: 167, column: 23, scope: !739)
!741 = !DILocation(line: 167, column: 5, scope: !734)
!742 = !DILocation(line: 168, column: 10, scope: !743)
!743 = distinct !DILexicalBlock(scope: !739, file: !3, line: 167, column: 39)
!744 = !DILocation(line: 167, column: 35, scope: !739)
!745 = !DILocation(line: 167, column: 5, scope: !739)
!746 = distinct !{!746, !741, !747}
!747 = !DILocation(line: 169, column: 13, scope: !734)
!748 = !DILocation(line: 174, column: 1, scope: !458)
!749 = distinct !DISubprogram(name: "memcpy", scope: !750, file: !750, line: 12, type: !751, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !125, retainedNodes: !4)
!750 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!751 = !DISubroutineType(types: !752)
!752 = !{!35, !35, !36, !753}
!753 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !754, line: 46, baseType: !41)
!754 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!755 = !DILocalVariable(name: "destaddr", arg: 1, scope: !749, file: !750, line: 12, type: !35)
!756 = !DILocation(line: 12, column: 20, scope: !749)
!757 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !749, file: !750, line: 12, type: !36)
!758 = !DILocation(line: 12, column: 42, scope: !749)
!759 = !DILocalVariable(name: "len", arg: 3, scope: !749, file: !750, line: 12, type: !753)
!760 = !DILocation(line: 12, column: 58, scope: !749)
!761 = !DILocalVariable(name: "dest", scope: !749, file: !750, line: 13, type: !65)
!762 = !DILocation(line: 13, column: 9, scope: !749)
!763 = !DILocation(line: 13, column: 16, scope: !749)
!764 = !DILocalVariable(name: "src", scope: !749, file: !750, line: 14, type: !69)
!765 = !DILocation(line: 14, column: 15, scope: !749)
!766 = !DILocation(line: 14, column: 21, scope: !749)
!767 = !DILocation(line: 16, column: 3, scope: !749)
!768 = !DILocation(line: 16, column: 13, scope: !749)
!769 = !DILocation(line: 16, column: 16, scope: !749)
!770 = !DILocation(line: 17, column: 19, scope: !749)
!771 = !DILocation(line: 17, column: 15, scope: !749)
!772 = !DILocation(line: 17, column: 10, scope: !749)
!773 = !DILocation(line: 17, column: 13, scope: !749)
!774 = distinct !{!774, !767, !770}
!775 = !DILocation(line: 18, column: 10, scope: !749)
!776 = !DILocation(line: 18, column: 3, scope: !749)
