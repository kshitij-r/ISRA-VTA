...
entry:
  ...
  %i = alloca i32, align 4
  %agg.tmp239 = alloca %struct.INSTR_VAL, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx240 = getelementptr inbounds [9 x %struct.INSTR_VAL], [9 x %struct.INSTR_VAL]* %microop_val, i64 0, i64 %idxprom, !dbg !1663
  %113 = bitcast %struct.INSTR_VAL* %agg.tmp239 to i8*, !dbg !1663
  %114 = bitcast %struct.INSTR_VAL* %arrayidx240 to i8*, !dbg !1663
  %115 = call i8* @memcpy(i8* %113, i8* %114, i64 24), !dbg !1663
  %call241 = call i32* @_Z17micro_decoder_val9INSTR_VAL(%struct.INSTR_VAL* byval(%struct.INSTR_VAL) align 8 %agg.tmp239), !dbg !1664
  store i32* %call241, i32** %acc_mem_val, align 8, !dbg !1665
  %116 = load i32*, i32** %acc_mem_val, align 8, !dbg !1666
  ...
  %arrayidx245 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage3, i64 0, i64 %idxprom244, !dbg !1669
...
!1653 = !DILocalVariable(name: "i", scope: !1654, file: !22, line: 178, type: !11)
!1654 = distinct !DILexicalBlock(scope: !1650, file: !22, line: 178, column: 9)
!1655 = !DILocation(line: 178, column: 18, scope: !1654)
!1656 = !DILocation(line: 178, column: 14, scope: !1654)
!1657 = !DILocation(line: 178, column: 22, scope: !1658)
!1658 = distinct !DILexicalBlock(scope: !1654, file: !22, line: 178, column: 9)
!1659 = !DILocation(line: 178, column: 23, scope: !1658)
!1660 = !DILocation(line: 178, column: 9, scope: !1654)
!1661 = !DILocation(line: 179, column: 57, scope: !1662)
!1662 = distinct !DILexicalBlock(scope: !1658, file: !22, line: 178, column: 30)
!1663 = !DILocation(line: 179, column: 45, scope: !1662)
!1664 = !DILocation(line: 179, column: 27, scope: !1662)
!1665 = !DILocation(line: 179, column: 25, scope: !1662)
!1666 = !DILocation(line: 180, column: 27, scope: !1662)
!1667 = !DILocation(line: 180, column: 39, scope: !1662)
!1668 = !DILocation(line: 180, column: 24, scope: !1662)
!1669 = !DILocation(line: 180, column: 13, scope: !1662)
!1670 = !DILocation(line: 180, column: 26, scope: !1662)
!1671 = !DILocation(line: 178, column: 27, scope: !1658)
!1672 = !DILocation(line: 178, column: 9, scope: !1658)
!1673 = distinct !{!1673, !1660, !1674}
!1674 = !DILocation(line: 181, column: 13, scope: !1654)
