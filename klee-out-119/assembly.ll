...
@.str.2 = private unnamed_addr constant [31 x i8] c"acc_stage1[i] == acc_stage3[i]\00", align 1
...
entry:
  ...
  %agg.tmp262 = alloca %struct.INSTR_VAL, align 8
  ...
  call void @llvm.dbg.declare(metadata i32* %i, metadata !632, metadata !DIExpression()), !dbg !634
  store i32 0, i32* %i, align 4, !dbg !634
  br label %for.cond, !dbg !635

for.cond:                                         ; preds = %for.body, %entry
  %106 = load i32, i32* %i, align 4, !dbg !636
  %cmp = icmp slt i32 %106, 9, !dbg !638
  br i1 %cmp, label %for.body, label %for.end, !dbg !639

for.body:                                         ; preds = %for.cond
  %107 = load i32*, i32** %acc_mem_gemm, align 8, !dbg !640
  %108 = load i32, i32* %i, align 4, !dbg !642
  %idxprom = sext i32 %108 to i64, !dbg !640
  %arrayidx237 = getelementptr inbounds i32, i32* %107, i64 %idxprom, !dbg !640
  %109 = load i32, i32* %arrayidx237, align 4, !dbg !640
  %110 = load i32, i32* %i, align 4, !dbg !643
  %idxprom238 = sext i32 %110 to i64, !dbg !644
  %arrayidx239 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage1, i64 0, i64 %idxprom238, !dbg !644
  store i32 %109, i32* %arrayidx239, align 4, !dbg !645
  %111 = load i32, i32* %i, align 4, !dbg !646
  %inc = add nsw i32 %111, 1, !dbg !646
  store i32 %inc, i32* %i, align 4, !dbg !646
  br label %for.cond, !dbg !647, !llvm.loop !648

for.end:                                          ; preds = %for.cond
  %112 = load i32, i32* %opcode, align 4, !dbg !650
  %cmp240 = icmp eq i32 %112, 2, !dbg !652
  %113 = load i32, i32* %op_type, align 4, !dbg !653
  %cmp241 = icmp uge i32 %113, 0, !dbg !654
  %or.cond = and i1 %cmp240, %cmp241, !dbg !655
  %114 = load i32, i32* %op_type, align 4, !dbg !656
  %cmp243 = icmp ule i32 %114, 3, !dbg !657
  %or.cond1 = and i1 %or.cond, %cmp243, !dbg !655
  br i1 %or.cond1, label %if.then, label %if.end, !dbg !655

if.then:                                          ; preds = %for.end
  call void @llvm.dbg.declare(metadata i32* %i244, metadata !658, metadata !DIExpression()), !dbg !661
  store i32 0, i32* %i244, align 4, !dbg !661
  br label %for.cond245, !dbg !662

for.cond245:                                      ; preds = %for.body247, %if.then
  %115 = load i32, i32* %i244, align 4, !dbg !663
  %cmp246 = icmp slt i32 %115, 9, !dbg !665
  br i1 %cmp246, label %for.body247, label %for.end257, !dbg !666

for.body247:                                      ; preds = %for.cond245
  %116 = load i32, i32* %i244, align 4, !dbg !667
  %idxprom248 = sext i32 %116 to i64, !dbg !669
  %arrayidx249 = getelementptr inbounds [9 x %struct.INSTR], [9 x %struct.INSTR]* %microop, i64 0, i64 %idxprom248, !dbg !669
  %117 = bitcast %struct.INSTR* %agg.tmp to i8*, !dbg !669
  %118 = bitcast %struct.INSTR* %arrayidx249 to i8*, !dbg !669
  %119 = call i8* @memcpy(i8* %117, i8* %118, i64 40), !dbg !669
  %call250 = call i32* @_Z13micro_decoder5INSTR(%struct.INSTR* byval(%struct.INSTR) align 8 %agg.tmp), !dbg !670
  store i32* %call250, i32** %acc_mem_ref, align 8, !dbg !671
  %120 = load i32*, i32** %acc_mem_ref, align 8, !dbg !672
  %121 = load i32, i32* %i244, align 4, !dbg !673
  %idxprom251 = sext i32 %121 to i64, !dbg !672
  %arrayidx252 = getelementptr inbounds i32, i32* %120, i64 %idxprom251, !dbg !672
  %122 = load i32, i32* %arrayidx252, align 4, !dbg !672
  %123 = load i32, i32* %i244, align 4, !dbg !674
  %idxprom253 = sext i32 %123 to i64, !dbg !675
  %arrayidx254 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage2, i64 0, i64 %idxprom253, !dbg !675
  store i32 %122, i32* %arrayidx254, align 4, !dbg !676
  %124 = load i32, i32* %i244, align 4, !dbg !677
  %inc256 = add nsw i32 %124, 1, !dbg !677
  store i32 %inc256, i32* %i244, align 4, !dbg !677
  br label %for.cond245, !dbg !678, !llvm.loop !679

for.end257:                                       ; preds = %for.cond245
  call void @llvm.dbg.declare(metadata i32* %i258, metadata !681, metadata !DIExpression()), !dbg !683
  store i32 0, i32* %i258, align 4, !dbg !683
  br label %for.cond259, !dbg !684

for.cond259:                                      ; preds = %for.body261, %for.end257
  %125 = load i32, i32* %i258, align 4, !dbg !685
  %cmp260 = icmp slt i32 %125, 9, !dbg !687
  br i1 %cmp260, label %for.body261, label %for.end272, !dbg !688

for.body261:                                      ; preds = %for.cond259
  %126 = load i32, i32* %i258, align 4, !dbg !689
  %idxprom263 = sext i32 %126 to i64, !dbg !691
  %arrayidx264 = getelementptr inbounds [9 x %struct.INSTR_VAL], [9 x %struct.INSTR_VAL]* %microop_val, i64 0, i64 %idxprom263, !dbg !691
  %127 = bitcast %struct.INSTR_VAL* %agg.tmp262 to i8*, !dbg !691
  %128 = bitcast %struct.INSTR_VAL* %arrayidx264 to i8*, !dbg !691
  %129 = call i8* @memcpy(i8* %127, i8* %128, i64 24), !dbg !691
  %call265 = call i32* @_Z17micro_decoder_val9INSTR_VAL(%struct.INSTR_VAL* byval(%struct.INSTR_VAL) align 8 %agg.tmp262), !dbg !692
  store i32* %call265, i32** %acc_mem_val, align 8, !dbg !693
  %130 = load i32*, i32** %acc_mem_val, align 8, !dbg !694
  %131 = load i32, i32* %i258, align 4, !dbg !695
  %idxprom266 = sext i32 %131 to i64, !dbg !694
  %arrayidx267 = getelementptr inbounds i32, i32* %130, i64 %idxprom266, !dbg !694
  %132 = load i32, i32* %arrayidx267, align 4, !dbg !694
  %133 = load i32, i32* %i258, align 4, !dbg !696
  %idxprom268 = sext i32 %133 to i64, !dbg !697
  %arrayidx269 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage3, i64 0, i64 %idxprom268, !dbg !697
  store i32 %132, i32* %arrayidx269, align 4, !dbg !698
  %134 = load i32, i32* %i258, align 4, !dbg !699
  %inc271 = add nsw i32 %134, 1, !dbg !699
  store i32 %inc271, i32* %i258, align 4, !dbg !699
  br label %for.cond259, !dbg !700, !llvm.loop !701

for.end272:                                       ; preds = %for.cond259
  call void @llvm.dbg.declare(metadata i32* %i273, metadata !703, metadata !DIExpression()), !dbg !705
  store i32 0, i32* %i273, align 4, !dbg !705
  br label %for.cond274, !dbg !706

for.cond274:                                      ; preds = %for.inc282, %for.end272
  %135 = load i32, i32* %i273, align 4, !dbg !707
  %cmp275 = icmp slt i32 %135, 9, !dbg !709
  br i1 %cmp275, label %for.body276, label %if.end, !dbg !710

for.body276:                                      ; preds = %for.cond274
  %136 = load i32, i32* %i273, align 4, !dbg !711
  %idxprom277 = sext i32 %136 to i64, !dbg !711
  %arrayidx278 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage1, i64 0, i64 %idxprom277, !dbg !711
  %137 = load i32, i32* %arrayidx278, align 4, !dbg !711
  %138 = load i32, i32* %i273, align 4, !dbg !711
  %idxprom279 = sext i32 %138 to i64, !dbg !711
  %arrayidx280 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage3, i64 0, i64 %idxprom279, !dbg !711
  %139 = load i32, i32* %arrayidx280, align 4, !dbg !711
  %cmp281 = icmp eq i32 %137, %139, !dbg !711
  br i1 %cmp281, label %for.inc282, label %cond.false, !dbg !711

cond.false:                                       ; preds = %for.body276
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 156, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !711
  unreachable, !dbg !711

for.inc282:                                       ; preds = %for.body276
  %140 = load i32, i32* %i273, align 4, !dbg !713
  %inc283 = add nsw i32 %140, 1, !dbg !713
  store i32 %inc283, i32* %i273, align 4, !dbg !713
  br label %for.cond274, !dbg !714, !llvm.loop !715

if.end:                                           ; preds = %for.cond274, %for.end
  ret i32 0, !dbg !717
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !718 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !724, metadata !DIExpression()), !dbg !725
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !726, metadata !DIExpression()), !dbg !727
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !728, metadata !DIExpression()), !dbg !729
  call void @llvm.dbg.declare(metadata i8** %7, metadata !730, metadata !DIExpression()), !dbg !731
  %9 = load i8*, i8** %4, align 8, !dbg !732
  store i8* %9, i8** %7, align 8, !dbg !731
  call void @llvm.dbg.declare(metadata i8** %8, metadata !733, metadata !DIExpression()), !dbg !734
  %10 = load i8*, i8** %5, align 8, !dbg !735
  store i8* %10, i8** %8, align 8, !dbg !734
  br label %11, !dbg !736

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !737
  %13 = add i64 %12, -1, !dbg !737
  store i64 %13, i64* %6, align 8, !dbg !737
  %14 = icmp ugt i64 %12, 0, !dbg !738
  br i1 %14, label %15, label %21, !dbg !736

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !739
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !739
  store i8* %17, i8** %8, align 8, !dbg !739
  %18 = load i8, i8* %16, align 1, !dbg !740
  %19 = load i8*, i8** %7, align 8, !dbg !741
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !741
  store i8* %20, i8** %7, align 8, !dbg !741
  store i8 %18, i8* %19, align 1, !dbg !742
  br label %11, !dbg !736, !llvm.loop !743

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !744
  ret i8* %22, !dbg !745
}
...
!632 = !DILocalVariable(name: "i", scope: !633, file: !3, line: 139, type: !40)
!633 = distinct !DILexicalBlock(scope: !444, file: !3, line: 139, column: 5)
!634 = !DILocation(line: 139, column: 14, scope: !633)
!635 = !DILocation(line: 139, column: 10, scope: !633)
!636 = !DILocation(line: 139, column: 18, scope: !637)
!637 = distinct !DILexicalBlock(scope: !633, file: !3, line: 139, column: 5)
!638 = !DILocation(line: 139, column: 19, scope: !637)
!639 = !DILocation(line: 139, column: 5, scope: !633)
!640 = !DILocation(line: 140, column: 23, scope: !641)
!641 = distinct !DILexicalBlock(scope: !637, file: !3, line: 139, column: 26)
!642 = !DILocation(line: 140, column: 36, scope: !641)
!643 = !DILocation(line: 140, column: 20, scope: !641)
!644 = !DILocation(line: 140, column: 9, scope: !641)
!645 = !DILocation(line: 140, column: 22, scope: !641)
!646 = !DILocation(line: 139, column: 23, scope: !637)
!647 = !DILocation(line: 139, column: 5, scope: !637)
!648 = distinct !{!648, !639, !649}
!649 = !DILocation(line: 141, column: 5, scope: !633)
!650 = !DILocation(line: 143, column: 10, scope: !651)
!651 = distinct !DILexicalBlock(scope: !444, file: !3, line: 143, column: 9)
!652 = !DILocation(line: 143, column: 17, scope: !651)
!653 = !DILocation(line: 143, column: 27, scope: !651)
!654 = !DILocation(line: 143, column: 35, scope: !651)
!655 = !DILocation(line: 143, column: 22, scope: !651)
!656 = !DILocation(line: 143, column: 45, scope: !651)
!657 = !DILocation(line: 143, column: 52, scope: !651)
!658 = !DILocalVariable(name: "i", scope: !659, file: !3, line: 144, type: !40)
!659 = distinct !DILexicalBlock(scope: !660, file: !3, line: 144, column: 9)
!660 = distinct !DILexicalBlock(scope: !651, file: !3, line: 143, column: 58)
!661 = !DILocation(line: 144, column: 18, scope: !659)
!662 = !DILocation(line: 144, column: 14, scope: !659)
!663 = !DILocation(line: 144, column: 22, scope: !664)
!664 = distinct !DILexicalBlock(scope: !659, file: !3, line: 144, column: 9)
!665 = !DILocation(line: 144, column: 23, scope: !664)
!666 = !DILocation(line: 144, column: 9, scope: !659)
!667 = !DILocation(line: 145, column: 49, scope: !668)
!668 = distinct !DILexicalBlock(scope: !664, file: !3, line: 144, column: 30)
!669 = !DILocation(line: 145, column: 41, scope: !668)
!670 = !DILocation(line: 145, column: 27, scope: !668)
!671 = !DILocation(line: 145, column: 25, scope: !668)
!672 = !DILocation(line: 146, column: 27, scope: !668)
!673 = !DILocation(line: 146, column: 39, scope: !668)
!674 = !DILocation(line: 146, column: 24, scope: !668)
!675 = !DILocation(line: 146, column: 13, scope: !668)
!676 = !DILocation(line: 146, column: 26, scope: !668)
!677 = !DILocation(line: 144, column: 27, scope: !664)
!678 = !DILocation(line: 144, column: 9, scope: !664)
!679 = distinct !{!679, !666, !680}
!680 = !DILocation(line: 147, column: 13, scope: !659)
!681 = !DILocalVariable(name: "i", scope: !682, file: !3, line: 148, type: !40)
!682 = distinct !DILexicalBlock(scope: !660, file: !3, line: 148, column: 9)
!683 = !DILocation(line: 148, column: 18, scope: !682)
!684 = !DILocation(line: 148, column: 14, scope: !682)
!685 = !DILocation(line: 148, column: 22, scope: !686)
!686 = distinct !DILexicalBlock(scope: !682, file: !3, line: 148, column: 9)
!687 = !DILocation(line: 148, column: 23, scope: !686)
!688 = !DILocation(line: 148, column: 9, scope: !682)
!689 = !DILocation(line: 149, column: 57, scope: !690)
!690 = distinct !DILexicalBlock(scope: !686, file: !3, line: 148, column: 30)
!691 = !DILocation(line: 149, column: 45, scope: !690)
!692 = !DILocation(line: 149, column: 27, scope: !690)
!693 = !DILocation(line: 149, column: 25, scope: !690)
!694 = !DILocation(line: 150, column: 27, scope: !690)
!695 = !DILocation(line: 150, column: 39, scope: !690)
!696 = !DILocation(line: 150, column: 24, scope: !690)
!697 = !DILocation(line: 150, column: 13, scope: !690)
!698 = !DILocation(line: 150, column: 26, scope: !690)
!699 = !DILocation(line: 148, column: 27, scope: !686)
!700 = !DILocation(line: 148, column: 9, scope: !686)
!701 = distinct !{!701, !688, !702}
!702 = !DILocation(line: 151, column: 13, scope: !682)
!703 = !DILocalVariable(name: "i", scope: !704, file: !3, line: 155, type: !40)
!704 = distinct !DILexicalBlock(scope: !660, file: !3, line: 155, column: 9)
!705 = !DILocation(line: 155, column: 18, scope: !704)
!706 = !DILocation(line: 155, column: 14, scope: !704)
!707 = !DILocation(line: 155, column: 25, scope: !708)
!708 = distinct !DILexicalBlock(scope: !704, file: !3, line: 155, column: 9)
!709 = !DILocation(line: 155, column: 27, scope: !708)
!710 = !DILocation(line: 155, column: 9, scope: !704)
!711 = !DILocation(line: 156, column: 10, scope: !712)
!712 = distinct !DILexicalBlock(scope: !708, file: !3, line: 155, column: 43)
!713 = !DILocation(line: 155, column: 39, scope: !708)
!714 = !DILocation(line: 155, column: 9, scope: !708)
!715 = distinct !{!715, !710, !716}
!716 = !DILocation(line: 157, column: 13, scope: !704)
!717 = !DILocation(line: 160, column: 1, scope: !444)
!718 = distinct !DISubprogram(name: "memcpy", scope: !719, file: !719, line: 12, type: !720, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !127, retainedNodes: !4)
!719 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!720 = !DISubroutineType(types: !721)
!721 = !{!37, !37, !38, !722}
!722 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !723, line: 46, baseType: !43)
!723 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!724 = !DILocalVariable(name: "destaddr", arg: 1, scope: !718, file: !719, line: 12, type: !37)
!725 = !DILocation(line: 12, column: 20, scope: !718)
!726 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !718, file: !719, line: 12, type: !38)
!727 = !DILocation(line: 12, column: 42, scope: !718)
!728 = !DILocalVariable(name: "len", arg: 3, scope: !718, file: !719, line: 12, type: !722)
!729 = !DILocation(line: 12, column: 58, scope: !718)
!730 = !DILocalVariable(name: "dest", scope: !718, file: !719, line: 13, type: !67)
!731 = !DILocation(line: 13, column: 9, scope: !718)
!732 = !DILocation(line: 13, column: 16, scope: !718)
!733 = !DILocalVariable(name: "src", scope: !718, file: !719, line: 14, type: !71)
!734 = !DILocation(line: 14, column: 15, scope: !718)
!735 = !DILocation(line: 14, column: 21, scope: !718)
!736 = !DILocation(line: 16, column: 3, scope: !718)
!737 = !DILocation(line: 16, column: 13, scope: !718)
!738 = !DILocation(line: 16, column: 16, scope: !718)
!739 = !DILocation(line: 17, column: 19, scope: !718)
!740 = !DILocation(line: 17, column: 15, scope: !718)
!741 = !DILocation(line: 17, column: 10, scope: !718)
!742 = !DILocation(line: 17, column: 13, scope: !718)
!743 = distinct !{!743, !736, !739}
!744 = !DILocation(line: 18, column: 10, scope: !718)
!745 = !DILocation(line: 18, column: 3, scope: !718)
