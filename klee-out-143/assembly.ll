...
for.cond280:                                      ; preds = %for.inc291, %for.end278
  ...
  br i1 %cmp281, label %for.body282, label %if.end, !dbg !736
...
cond.false289:                                    ; preds = %for.body282
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 166, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !737
  unreachable, !dbg !737
...
!730 = distinct !DILexicalBlock(scope: !666, file: !3, line: 165, column: 9)
!731 = !DILocation(line: 165, column: 18, scope: !730)
!732 = !DILocation(line: 165, column: 14, scope: !730)
!733 = !DILocation(line: 165, column: 25, scope: !734)
!734 = distinct !DILexicalBlock(scope: !730, file: !3, line: 165, column: 9)
!735 = !DILocation(line: 165, column: 27, scope: !734)
!736 = !DILocation(line: 165, column: 9, scope: !730)
!737 = !DILocation(line: 166, column: 10, scope: !738)
!738 = distinct !DILexicalBlock(scope: !734, file: !3, line: 165, column: 43)
!739 = !DILocation(line: 165, column: 39, scope: !734)
!740 = !DILocation(line: 165, column: 9, scope: !734)
!741 = distinct !{!741, !736, !742}
!742 = !DILocation(line: 167, column: 13, scope: !730)
!743 = !DILocation(line: 173, column: 1, scope: !458)
