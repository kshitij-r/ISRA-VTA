...
for.body268:                                      ; preds = %for.cond266
  %128 = load i32*, i32** %acc_mem_ref, align 8, !dbg !701
  ...
  %131 = load i32*, i32** %acc_mem_gemm, align 8, !dbg !701
...
cond.false:                                       ; preds = %for.body268
  call void @__assert_fail(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 153, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !701
  unreachable, !dbg !701
...
!693 = !DILocalVariable(name: "i", scope: !694, file: !3, line: 152, type: !40)
!694 = distinct !DILexicalBlock(scope: !660, file: !3, line: 152, column: 9)
!695 = !DILocation(line: 152, column: 18, scope: !694)
!696 = !DILocation(line: 152, column: 14, scope: !694)
!697 = !DILocation(line: 152, column: 25, scope: !698)
!698 = distinct !DILexicalBlock(scope: !694, file: !3, line: 152, column: 9)
!699 = !DILocation(line: 152, column: 27, scope: !698)
!700 = !DILocation(line: 152, column: 9, scope: !694)
!701 = !DILocation(line: 153, column: 10, scope: !702)
!702 = distinct !DILexicalBlock(scope: !698, file: !3, line: 152, column: 43)
!703 = !DILocation(line: 152, column: 39, scope: !698)
!704 = !DILocation(line: 152, column: 9, scope: !698)
!705 = distinct !{!705, !700, !706}
!706 = !DILocation(line: 154, column: 13, scope: !694)
