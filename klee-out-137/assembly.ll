...
@.str.4 = private unnamed_addr constant [32 x i8] c"acc_mem_ref[i] == acc_stage1[i]\00", align 1
...
for.cond268:                                      ; preds = %for.inc276, %for.end266
  ...
  br i1 %cmp269, label %for.body270, label %if.end, !dbg !716

for.body270:                                      ; preds = %for.cond268
  %130 = load i32, i32* %i267, align 4, !dbg !717
  %idxprom271 = sext i32 %130 to i64, !dbg !719
  %arrayidx272 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage2, i64 0, i64 %idxprom271, !dbg !719
  %131 = load i32, i32* %arrayidx272, align 4, !dbg !719
  %132 = load i32, i32* %i267, align 4, !dbg !720
  %idxprom273 = sext i32 %132 to i64, !dbg !721
  %arrayidx274 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage3, i64 0, i64 %idxprom273, !dbg !721
  %133 = load i32, i32* %arrayidx274, align 4, !dbg !721
  %cmp275 = icmp eq i32 %131, %133, !dbg !722
  br i1 %cmp275, label %for.inc276, label %cond.false, !dbg !723

cond.false:                                       ; preds = %for.body270
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 162, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !724
  unreachable, !dbg !724

for.inc276:                                       ; preds = %for.body270
  %134 = load i32, i32* %i267, align 4, !dbg !725
  %inc277 = add nsw i32 %134, 1, !dbg !725
  store i32 %inc277, i32* %i267, align 4, !dbg !725
  br label %for.cond268, !dbg !726, !llvm.loop !727

if.end:                                           ; preds = %for.cond268, %for.end
  call void @llvm.dbg.declare(metadata i32* %i279, metadata !729, metadata !DIExpression()), !dbg !731
  store i32 0, i32* %i279, align 4, !dbg !731
  br label %for.cond280, !dbg !732

for.cond280:                                      ; preds = %for.inc291, %if.end
  %135 = load i32, i32* %i279, align 4, !dbg !733
  %cmp281 = icmp slt i32 %135, 9, !dbg !735
  br i1 %cmp281, label %for.body282, label %for.end293, !dbg !736

for.body282:                                      ; preds = %for.cond280
  %136 = load i32*, i32** %acc_mem_ref, align 8, !dbg !737
  %137 = load i32, i32* %i279, align 4, !dbg !739
  %idxprom283 = sext i32 %137 to i64, !dbg !737
  %arrayidx284 = getelementptr inbounds i32, i32* %136, i64 %idxprom283, !dbg !737
  %138 = load i32, i32* %arrayidx284, align 4, !dbg !737
  %139 = load i32, i32* %i279, align 4, !dbg !740
  %idxprom285 = sext i32 %139 to i64, !dbg !741
  %arrayidx286 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage1, i64 0, i64 %idxprom285, !dbg !741
  %140 = load i32, i32* %arrayidx286, align 4, !dbg !741
  %cmp287 = icmp eq i32 %138, %140, !dbg !742
  br i1 %cmp287, label %for.inc291, label %cond.false289, !dbg !743

cond.false289:                                    ; preds = %for.body282
  call void @__assert_fail(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 167, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !744
  unreachable, !dbg !744

for.inc291:                                       ; preds = %for.body282
  %141 = load i32, i32* %i279, align 4, !dbg !745
  %inc292 = add nsw i32 %141, 1, !dbg !745
  store i32 %inc292, i32* %i279, align 4, !dbg !745
  br label %for.cond280, !dbg !746, !llvm.loop !747
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !750 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %5, metadata !758, metadata !DIExpression()), !dbg !759
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !760, metadata !DIExpression()), !dbg !761
  call void @llvm.dbg.declare(metadata i8** %7, metadata !762, metadata !DIExpression()), !dbg !763
  %9 = load i8*, i8** %4, align 8, !dbg !764
  store i8* %9, i8** %7, align 8, !dbg !763
  call void @llvm.dbg.declare(metadata i8** %8, metadata !765, metadata !DIExpression()), !dbg !766
  %10 = load i8*, i8** %5, align 8, !dbg !767
  store i8* %10, i8** %8, align 8, !dbg !766
  br label %11, !dbg !768

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !769
  %13 = add i64 %12, -1, !dbg !769
  store i64 %13, i64* %6, align 8, !dbg !769
  %14 = icmp ugt i64 %12, 0, !dbg !770
  br i1 %14, label %15, label %21, !dbg !768

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !771
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !771
  store i8* %17, i8** %8, align 8, !dbg !771
  %18 = load i8, i8* %16, align 1, !dbg !772
  %19 = load i8*, i8** %7, align 8, !dbg !773
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !773
  store i8* %20, i8** %7, align 8, !dbg !773
  store i8 %18, i8* %19, align 1, !dbg !774
  br label %11, !dbg !768, !llvm.loop !775
...
!709 = !DILocalVariable(name: "i", scope: !710, file: !3, line: 161, type: !38)
!710 = distinct !DILexicalBlock(scope: !666, file: !3, line: 161, column: 9)
!711 = !DILocation(line: 161, column: 18, scope: !710)
!712 = !DILocation(line: 161, column: 14, scope: !710)
!713 = !DILocation(line: 161, column: 25, scope: !714)
!714 = distinct !DILexicalBlock(scope: !710, file: !3, line: 161, column: 9)
!715 = !DILocation(line: 161, column: 27, scope: !714)
!716 = !DILocation(line: 161, column: 9, scope: !710)
!717 = !DILocation(line: 162, column: 42, scope: !718)
!718 = distinct !DILexicalBlock(scope: !714, file: !3, line: 161, column: 43)
!719 = !DILocation(line: 162, column: 31, scope: !718)
!720 = !DILocation(line: 162, column: 59, scope: !718)
!721 = !DILocation(line: 162, column: 48, scope: !718)
!722 = !DILocation(line: 162, column: 45, scope: !718)
!723 = !DILocation(line: 162, column: 11, scope: !718)
!724 = !DILocation(line: 162, column: 76, scope: !718)
!725 = !DILocation(line: 161, column: 39, scope: !714)
!726 = !DILocation(line: 161, column: 9, scope: !714)
!727 = distinct !{!727, !716, !728}
!728 = !DILocation(line: 163, column: 13, scope: !710)
!729 = !DILocalVariable(name: "i", scope: !730, file: !3, line: 166, type: !38)
!730 = distinct !DILexicalBlock(scope: !458, file: !3, line: 166, column: 5)
!731 = !DILocation(line: 166, column: 14, scope: !730)
!732 = !DILocation(line: 166, column: 10, scope: !730)
!733 = !DILocation(line: 166, column: 21, scope: !734)
!734 = distinct !DILexicalBlock(scope: !730, file: !3, line: 166, column: 5)
!735 = !DILocation(line: 166, column: 23, scope: !734)
!736 = !DILocation(line: 166, column: 5, scope: !730)
!737 = !DILocation(line: 167, column: 31, scope: !738)
!738 = distinct !DILexicalBlock(scope: !734, file: !3, line: 166, column: 39)
!739 = !DILocation(line: 167, column: 43, scope: !738)
!740 = !DILocation(line: 167, column: 60, scope: !738)
!741 = !DILocation(line: 167, column: 49, scope: !738)
!742 = !DILocation(line: 167, column: 46, scope: !738)
!743 = !DILocation(line: 167, column: 11, scope: !738)
!744 = !DILocation(line: 167, column: 77, scope: !738)
!745 = !DILocation(line: 166, column: 35, scope: !734)
!746 = !DILocation(line: 166, column: 5, scope: !734)
!747 = distinct !{!747, !736, !748}
!748 = !DILocation(line: 168, column: 13, scope: !730)
!749 = !DILocation(line: 170, column: 1, scope: !458)
!750 = distinct !DISubprogram(name: "memcpy", scope: !751, file: !751, line: 12, type: !752, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !125, retainedNodes: !4)
!751 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!752 = !DISubroutineType(types: !753)
!753 = !{!35, !35, !36, !754}
!754 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !755, line: 46, baseType: !41)
!755 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!756 = !DILocalVariable(name: "destaddr", arg: 1, scope: !750, file: !751, line: 12, type: !35)
!757 = !DILocation(line: 12, column: 20, scope: !750)
!758 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !750, file: !751, line: 12, type: !36)
!759 = !DILocation(line: 12, column: 42, scope: !750)
!760 = !DILocalVariable(name: "len", arg: 3, scope: !750, file: !751, line: 12, type: !754)
!761 = !DILocation(line: 12, column: 58, scope: !750)
!762 = !DILocalVariable(name: "dest", scope: !750, file: !751, line: 13, type: !65)
!763 = !DILocation(line: 13, column: 9, scope: !750)
!764 = !DILocation(line: 13, column: 16, scope: !750)
!765 = !DILocalVariable(name: "src", scope: !750, file: !751, line: 14, type: !69)
!766 = !DILocation(line: 14, column: 15, scope: !750)
!767 = !DILocation(line: 14, column: 21, scope: !750)
!768 = !DILocation(line: 16, column: 3, scope: !750)
!769 = !DILocation(line: 16, column: 13, scope: !750)
!770 = !DILocation(line: 16, column: 16, scope: !750)
!771 = !DILocation(line: 17, column: 19, scope: !750)
!772 = !DILocation(line: 17, column: 15, scope: !750)
!773 = !DILocation(line: 17, column: 10, scope: !750)
!774 = !DILocation(line: 17, column: 13, scope: !750)
!775 = distinct !{!775, !768, !771}
!776 = !DILocation(line: 18, column: 10, scope: !750)
!777 = !DILocation(line: 18, column: 3, scope: !750)
