...
for.body:                                         ; preds = %for.cond
  %112 = load i32*, i32** %acc_mem_gemm, align 8, !dbg !1661
  %113 = load i32, i32* %i, align 4, !dbg !1663
  %idxprom = sext i32 %113 to i64, !dbg !1661
  %arrayidx239 = getelementptr inbounds i32, i32* %112, i64 %idxprom, !dbg !1661
  %114 = load i32, i32* %arrayidx239, align 4, !dbg !1661
  %115 = load i32, i32* %i, align 4, !dbg !1664
  %idxprom240 = sext i32 %115 to i64, !dbg !1665
  %arrayidx241 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage1, i64 0, i64 %idxprom240, !dbg !1665
  store i32 %114, i32* %arrayidx241, align 4, !dbg !1666
  %116 = load i32, i32* %i, align 4, !dbg !1667
  %inc = add nsw i32 %116, 1, !dbg !1667
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_gemm.cpp() #0 section ".text.startup" !dbg !1672 {
entry:
  call void @__cxx_global_var_init(), !dbg !1674
  ret void
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #4 !dbg !1675 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1681, metadata !DIExpression()), !dbg !1682
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1683, metadata !DIExpression()), !dbg !1684
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1685, metadata !DIExpression()), !dbg !1686
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1687, metadata !DIExpression()), !dbg !1688
  %9 = load i8*, i8** %4, align 8, !dbg !1689
  store i8* %9, i8** %7, align 8, !dbg !1688
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1690, metadata !DIExpression()), !dbg !1691
  %10 = load i8*, i8** %5, align 8, !dbg !1692
  store i8* %10, i8** %8, align 8, !dbg !1691
  br label %11, !dbg !1693

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1694
  %13 = add i64 %12, -1, !dbg !1694
  store i64 %13, i64* %6, align 8, !dbg !1694
  %14 = icmp ugt i64 %12, 0, !dbg !1695
  br i1 %14, label %15, label %21, !dbg !1693

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1696
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1696
  store i8* %17, i8** %8, align 8, !dbg !1696
  %18 = load i8, i8* %16, align 1, !dbg !1697
  %19 = load i8*, i8** %7, align 8, !dbg !1698
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1698
  store i8* %20, i8** %7, align 8, !dbg !1698
  store i8 %18, i8* %19, align 1, !dbg !1699
  br label %11, !dbg !1693, !llvm.loop !1700

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1701
  ret i8* %22, !dbg !1702
}
...
!1653 = !DILocalVariable(name: "i", scope: !1654, file: !22, line: 171, type: !11)
!1654 = distinct !DILexicalBlock(scope: !1650, file: !22, line: 171, column: 9)
!1655 = !DILocation(line: 171, column: 18, scope: !1654)
!1656 = !DILocation(line: 171, column: 14, scope: !1654)
!1657 = !DILocation(line: 171, column: 22, scope: !1658)
!1658 = distinct !DILexicalBlock(scope: !1654, file: !22, line: 171, column: 9)
!1659 = !DILocation(line: 171, column: 23, scope: !1658)
!1660 = !DILocation(line: 171, column: 9, scope: !1654)
!1661 = !DILocation(line: 172, column: 27, scope: !1662)
!1662 = distinct !DILexicalBlock(scope: !1658, file: !22, line: 171, column: 30)
!1663 = !DILocation(line: 172, column: 40, scope: !1662)
!1664 = !DILocation(line: 172, column: 24, scope: !1662)
!1665 = !DILocation(line: 172, column: 13, scope: !1662)
!1666 = !DILocation(line: 172, column: 26, scope: !1662)
!1667 = !DILocation(line: 171, column: 27, scope: !1658)
!1668 = !DILocation(line: 171, column: 9, scope: !1658)
!1669 = distinct !{!1669, !1660, !1670}
!1670 = !DILocation(line: 173, column: 10, scope: !1654)
!1671 = !DILocation(line: 211, column: 1, scope: !1458)
!1672 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_gemm.cpp", scope: !22, file: !22, type: !1673, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !21, retainedNodes: !23)
!1673 = !DISubroutineType(types: !23)
!1674 = !DILocation(line: 0, scope: !1672)
!1675 = distinct !DISubprogram(name: "memcpy", scope: !1676, file: !1676, line: 12, type: !1677, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !1017, retainedNodes: !23)
!1676 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1677 = !DISubroutineType(types: !1678)
!1678 = !{!58, !58, !59, !1679}
!1679 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1680, line: 46, baseType: !63)
!1680 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!1681 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1675, file: !1676, line: 12, type: !58)
!1682 = !DILocation(line: 12, column: 20, scope: !1675)
!1683 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1675, file: !1676, line: 12, type: !59)
!1684 = !DILocation(line: 12, column: 42, scope: !1675)
!1685 = !DILocalVariable(name: "len", arg: 3, scope: !1675, file: !1676, line: 12, type: !1679)
!1686 = !DILocation(line: 12, column: 58, scope: !1675)
!1687 = !DILocalVariable(name: "dest", scope: !1675, file: !1676, line: 13, type: !87)
!1688 = !DILocation(line: 13, column: 9, scope: !1675)
!1689 = !DILocation(line: 13, column: 16, scope: !1675)
!1690 = !DILocalVariable(name: "src", scope: !1675, file: !1676, line: 14, type: !91)
!1691 = !DILocation(line: 14, column: 15, scope: !1675)
!1692 = !DILocation(line: 14, column: 21, scope: !1675)
!1693 = !DILocation(line: 16, column: 3, scope: !1675)
!1694 = !DILocation(line: 16, column: 13, scope: !1675)
!1695 = !DILocation(line: 16, column: 16, scope: !1675)
!1696 = !DILocation(line: 17, column: 19, scope: !1675)
!1697 = !DILocation(line: 17, column: 15, scope: !1675)
!1698 = !DILocation(line: 17, column: 10, scope: !1675)
!1699 = !DILocation(line: 17, column: 13, scope: !1675)
!1700 = distinct !{!1700, !1693, !1696}
!1701 = !DILocation(line: 18, column: 10, scope: !1675)
!1702 = !DILocation(line: 18, column: 3, scope: !1675)
