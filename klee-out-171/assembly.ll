...
entry:
  ...
  %cmp = icmp eq i32 %106, 2, !dbg !1644
  %107 = load i32, i32* %op_type, align 4, !dbg !1645
  %cmp237 = icmp eq i32 %107, 0, !dbg !1645
  %108 = select i1 %cmp, i1 %cmp237, i1 false, !dbg !1645
  %conv = zext i1 %108 to i64, !dbg !1646
  call void @klee_assume(i64 %conv), !dbg !1647
  %109 = bitcast %struct.INSTR* %agg.tmp to i8*, !dbg !1648
  %110 = bitcast %struct.INSTR* %instruction to i8*, !dbg !1648
  %111 = call i8* @memcpy(i8* %109, i8* %110, i64 40), !dbg !1648
  %call = call i32* @_Z9base_gemm5INSTR(%struct.INSTR* byval(%struct.INSTR) align 8 %agg.tmp), !dbg !1649
  store i32* %call, i32** %acc_mem_gemm, align 8, !dbg !1650
  ret i32 0, !dbg !1651
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_gemm.cpp() #0 section ".text.startup" !dbg !1652 {
entry:
  call void @__cxx_global_var_init(), !dbg !1654
  ret void
}

; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #4 !dbg !1655 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !1661, metadata !DIExpression()), !dbg !1662
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !1663, metadata !DIExpression()), !dbg !1664
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !1665, metadata !DIExpression()), !dbg !1666
  call void @llvm.dbg.declare(metadata i8** %7, metadata !1667, metadata !DIExpression()), !dbg !1668
  %9 = load i8*, i8** %4, align 8, !dbg !1669
  store i8* %9, i8** %7, align 8, !dbg !1668
  call void @llvm.dbg.declare(metadata i8** %8, metadata !1670, metadata !DIExpression()), !dbg !1671
  %10 = load i8*, i8** %5, align 8, !dbg !1672
  store i8* %10, i8** %8, align 8, !dbg !1671
  br label %11, !dbg !1673

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !1674
  %13 = add i64 %12, -1, !dbg !1674
  store i64 %13, i64* %6, align 8, !dbg !1674
  %14 = icmp ugt i64 %12, 0, !dbg !1675
  br i1 %14, label %15, label %21, !dbg !1673

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !1676
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !1676
  store i8* %17, i8** %8, align 8, !dbg !1676
  %18 = load i8, i8* %16, align 1, !dbg !1677
  %19 = load i8*, i8** %7, align 8, !dbg !1678
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !1678
  store i8* %20, i8** %7, align 8, !dbg !1678
  store i8 %18, i8* %19, align 1, !dbg !1679
  br label %11, !dbg !1673, !llvm.loop !1680

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !1681
  ret i8* %22, !dbg !1682
}
...
!1643 = !DILocation(line: 168, column: 18, scope: !1458)
!1644 = !DILocation(line: 168, column: 24, scope: !1458)
!1645 = !DILocation(line: 168, column: 29, scope: !1458)
!1646 = !DILocation(line: 168, column: 17, scope: !1458)
!1647 = !DILocation(line: 168, column: 5, scope: !1458)
!1648 = !DILocation(line: 170, column: 35, scope: !1458)
!1649 = !DILocation(line: 170, column: 25, scope: !1458)
!1650 = !DILocation(line: 170, column: 23, scope: !1458)
!1651 = !DILocation(line: 211, column: 1, scope: !1458)
!1652 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_gemm.cpp", scope: !22, file: !22, type: !1653, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !21, retainedNodes: !23)
!1653 = !DISubroutineType(types: !23)
!1654 = !DILocation(line: 0, scope: !1652)
!1655 = distinct !DISubprogram(name: "memcpy", scope: !1656, file: !1656, line: 12, type: !1657, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !1017, retainedNodes: !23)
!1656 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!1657 = !DISubroutineType(types: !1658)
!1658 = !{!58, !58, !59, !1659}
!1659 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !1660, line: 46, baseType: !63)
!1660 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!1661 = !DILocalVariable(name: "destaddr", arg: 1, scope: !1655, file: !1656, line: 12, type: !58)
!1662 = !DILocation(line: 12, column: 20, scope: !1655)
!1663 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !1655, file: !1656, line: 12, type: !59)
!1664 = !DILocation(line: 12, column: 42, scope: !1655)
!1665 = !DILocalVariable(name: "len", arg: 3, scope: !1655, file: !1656, line: 12, type: !1659)
!1666 = !DILocation(line: 12, column: 58, scope: !1655)
!1667 = !DILocalVariable(name: "dest", scope: !1655, file: !1656, line: 13, type: !87)
!1668 = !DILocation(line: 13, column: 9, scope: !1655)
!1669 = !DILocation(line: 13, column: 16, scope: !1655)
!1670 = !DILocalVariable(name: "src", scope: !1655, file: !1656, line: 14, type: !91)
!1671 = !DILocation(line: 14, column: 15, scope: !1655)
!1672 = !DILocation(line: 14, column: 21, scope: !1655)
!1673 = !DILocation(line: 16, column: 3, scope: !1655)
!1674 = !DILocation(line: 16, column: 13, scope: !1655)
!1675 = !DILocation(line: 16, column: 16, scope: !1655)
!1676 = !DILocation(line: 17, column: 19, scope: !1655)
!1677 = !DILocation(line: 17, column: 15, scope: !1655)
!1678 = !DILocation(line: 17, column: 10, scope: !1655)
!1679 = !DILocation(line: 17, column: 13, scope: !1655)
!1680 = distinct !{!1680, !1673, !1676}
!1681 = !DILocation(line: 18, column: 10, scope: !1655)
!1682 = !DILocation(line: 18, column: 3, scope: !1655)
