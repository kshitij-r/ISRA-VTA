...
for.body270:                                      ; preds = %for.cond268
  ...
  %arrayidx272 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage1, i64 0, i64 %idxprom271, !dbg !717
  %131 = load i32, i32* %arrayidx272, align 4, !dbg !717
  %132 = load i32, i32* %i267, align 4, !dbg !717
  %idxprom273 = sext i32 %132 to i64, !dbg !717
  %arrayidx274 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage3, i64 0, i64 %idxprom273, !dbg !717
...
cond.false:                                       ; preds = %for.body270
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 162, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !717
  unreachable, !dbg !717
...
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !724 {
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !730, metadata !DIExpression()), !dbg !731
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !732, metadata !DIExpression()), !dbg !733
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !734, metadata !DIExpression()), !dbg !735
  call void @llvm.dbg.declare(metadata i8** %7, metadata !736, metadata !DIExpression()), !dbg !737
  %9 = load i8*, i8** %4, align 8, !dbg !738
  store i8* %9, i8** %7, align 8, !dbg !737
  call void @llvm.dbg.declare(metadata i8** %8, metadata !739, metadata !DIExpression()), !dbg !740
  %10 = load i8*, i8** %5, align 8, !dbg !741
  store i8* %10, i8** %8, align 8, !dbg !740
  br label %11, !dbg !742

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !743
  %13 = add i64 %12, -1, !dbg !743
  store i64 %13, i64* %6, align 8, !dbg !743
  %14 = icmp ugt i64 %12, 0, !dbg !744
  br i1 %14, label %15, label %21, !dbg !742

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !745
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !745
  store i8* %17, i8** %8, align 8, !dbg !745
  %18 = load i8, i8* %16, align 1, !dbg !746
  %19 = load i8*, i8** %7, align 8, !dbg !747
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !747
  store i8* %20, i8** %7, align 8, !dbg !747
  store i8 %18, i8* %19, align 1, !dbg !748
  br label %11, !dbg !742, !llvm.loop !749

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !750
  ret i8* %22, !dbg !751
}
...
!717 = !DILocation(line: 162, column: 10, scope: !718)
!718 = distinct !DILexicalBlock(scope: !714, file: !3, line: 161, column: 43)
!719 = !DILocation(line: 161, column: 39, scope: !714)
!720 = !DILocation(line: 161, column: 9, scope: !714)
!721 = distinct !{!721, !716, !722}
!722 = !DILocation(line: 163, column: 13, scope: !710)
!723 = !DILocation(line: 166, column: 1, scope: !458)
!724 = distinct !DISubprogram(name: "memcpy", scope: !725, file: !725, line: 12, type: !726, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !125, retainedNodes: !4)
!725 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!726 = !DISubroutineType(types: !727)
!727 = !{!35, !35, !36, !728}
!728 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !729, line: 46, baseType: !41)
!729 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!730 = !DILocalVariable(name: "destaddr", arg: 1, scope: !724, file: !725, line: 12, type: !35)
!731 = !DILocation(line: 12, column: 20, scope: !724)
!732 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !724, file: !725, line: 12, type: !36)
!733 = !DILocation(line: 12, column: 42, scope: !724)
!734 = !DILocalVariable(name: "len", arg: 3, scope: !724, file: !725, line: 12, type: !728)
!735 = !DILocation(line: 12, column: 58, scope: !724)
!736 = !DILocalVariable(name: "dest", scope: !724, file: !725, line: 13, type: !65)
!737 = !DILocation(line: 13, column: 9, scope: !724)
!738 = !DILocation(line: 13, column: 16, scope: !724)
!739 = !DILocalVariable(name: "src", scope: !724, file: !725, line: 14, type: !69)
!740 = !DILocation(line: 14, column: 15, scope: !724)
!741 = !DILocation(line: 14, column: 21, scope: !724)
!742 = !DILocation(line: 16, column: 3, scope: !724)
!743 = !DILocation(line: 16, column: 13, scope: !724)
!744 = !DILocation(line: 16, column: 16, scope: !724)
!745 = !DILocation(line: 17, column: 19, scope: !724)
!746 = !DILocation(line: 17, column: 15, scope: !724)
!747 = !DILocation(line: 17, column: 10, scope: !724)
!748 = !DILocation(line: 17, column: 13, scope: !724)
!749 = distinct !{!749, !742, !745}
!750 = !DILocation(line: 18, column: 10, scope: !724)
!751 = !DILocation(line: 18, column: 3, scope: !724)
