...
define dso_local i32 @main(i32, i8**) #2 !dbg !436 {
  ...
  br i1 %387, label %388, label %422, !dbg !627

388:                                              ; preds = %2
  call void @llvm.dbg.declare(metadata i32* %29, metadata !628, metadata !DIExpression()), !dbg !631
  store i32 0, i32* %29, align 4, !dbg !631
  br label %389, !dbg !632

389:                                              ; preds = %392, %388
  %390 = load i32, i32* %29, align 4, !dbg !633
  %391 = icmp slt i32 %390, 9, !dbg !635
  br i1 %391, label %392, label %402, !dbg !636

392:                                              ; preds = %389
  %393 = load i32, i32* %29, align 4, !dbg !637
  %394 = sext i32 %393 to i64, !dbg !639
  %395 = getelementptr inbounds [9 x %struct.INSTR], [9 x %struct.INSTR]* %27, i64 0, i64 %394, !dbg !639
  %396 = bitcast %struct.INSTR* %30 to i8*, !dbg !639
  %397 = bitcast %struct.INSTR* %395 to i8*, !dbg !639
  %398 = call i8* @memcpy(i8* %396, i8* %397, i64 40), !dbg !639
  %399 = call i32* @_Z13micro_decoder5INSTR(%struct.INSTR* byval(%struct.INSTR) align 8 %30), !dbg !640
  store i32* %399, i32** %15, align 8, !dbg !641
  %400 = load i32, i32* %29, align 4, !dbg !642
  %401 = add nsw i32 %400, 1, !dbg !642
  store i32 %401, i32* %29, align 4, !dbg !642
...
402:                                              ; preds = %389
  ...
  br label %403, !dbg !649

403:                                              ; preds = %419, %402
  %404 = load i32, i32* %31, align 4, !dbg !650
  %405 = icmp slt i32 %404, 9, !dbg !652
  br i1 %405, label %406, label %422, !dbg !653

406:                                              ; preds = %403
  %407 = load i32*, i32** %15, align 8, !dbg !654
  %408 = load i32, i32* %31, align 4, !dbg !654
  %409 = sext i32 %408 to i64, !dbg !654
  %410 = getelementptr inbounds i32, i32* %407, i64 %409, !dbg !654
  %411 = load i32, i32* %410, align 4, !dbg !654
  %412 = load i32*, i32** %17, align 8, !dbg !654
  %413 = load i32, i32* %31, align 4, !dbg !654
  %414 = sext i32 %413 to i64, !dbg !654
  %415 = getelementptr inbounds i32, i32* %412, i64 %414, !dbg !654
  %416 = load i32, i32* %415, align 4, !dbg !654
  %417 = icmp eq i32 %411, %416, !dbg !654
  br i1 %417, label %419, label %418, !dbg !654

418:                                              ; preds = %406
  call void @__assert_fail(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 152, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !654
  unreachable, !dbg !654

419:                                              ; preds = %406
  %420 = load i32, i32* %31, align 4, !dbg !656
  %421 = add nsw i32 %420, 1, !dbg !656
  store i32 %421, i32* %31, align 4, !dbg !656
  br label %403, !dbg !657, !llvm.loop !658
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !661 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !663, metadata !DIExpression()), !dbg !664
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !665, metadata !DIExpression()), !dbg !666
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !667, metadata !DIExpression()), !dbg !668
  call void @llvm.dbg.declare(metadata i8** %7, metadata !669, metadata !DIExpression()), !dbg !670
  %9 = load i8*, i8** %4, align 8, !dbg !671
  store i8* %9, i8** %7, align 8, !dbg !670
  call void @llvm.dbg.declare(metadata i8** %8, metadata !672, metadata !DIExpression()), !dbg !673
  %10 = load i8*, i8** %5, align 8, !dbg !674
  store i8* %10, i8** %8, align 8, !dbg !673
  br label %11, !dbg !675

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !676
  %13 = add i64 %12, -1, !dbg !676
  store i64 %13, i64* %6, align 8, !dbg !676
  %14 = icmp ugt i64 %12, 0, !dbg !677
  br i1 %14, label %15, label %21, !dbg !675

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !678
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !678
  store i8* %17, i8** %8, align 8, !dbg !678
  %18 = load i8, i8* %16, align 1, !dbg !679
  %19 = load i8*, i8** %7, align 8, !dbg !680
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !680
  store i8* %20, i8** %7, align 8, !dbg !680
  store i8 %18, i8* %19, align 1, !dbg !681
  br label %11, !dbg !675, !llvm.loop !682

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !683
  ret i8* %22, !dbg !684
}
...
!646 = !DILocalVariable(name: "i", scope: !647, file: !3, line: 151, type: !37)
!647 = distinct !DILexicalBlock(scope: !630, file: !3, line: 151, column: 9)
!648 = !DILocation(line: 151, column: 18, scope: !647)
!649 = !DILocation(line: 151, column: 14, scope: !647)
!650 = !DILocation(line: 151, column: 25, scope: !651)
!651 = distinct !DILexicalBlock(scope: !647, file: !3, line: 151, column: 9)
!652 = !DILocation(line: 151, column: 27, scope: !651)
!653 = !DILocation(line: 151, column: 9, scope: !647)
!654 = !DILocation(line: 152, column: 10, scope: !655)
!655 = distinct !DILexicalBlock(scope: !651, file: !3, line: 151, column: 43)
!656 = !DILocation(line: 151, column: 39, scope: !651)
!657 = !DILocation(line: 151, column: 9, scope: !651)
!658 = distinct !{!658, !653, !659}
!659 = !DILocation(line: 153, column: 13, scope: !647)
!660 = !DILocation(line: 159, column: 1, scope: !436)
!661 = distinct !DISubprogram(name: "memcpy", scope: !662, file: !662, line: 12, type: !54, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !121, retainedNodes: !4)
!662 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!663 = !DILocalVariable(name: "destaddr", arg: 1, scope: !661, file: !662, line: 12, type: !34)
!664 = !DILocation(line: 12, column: 20, scope: !661)
!665 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !661, file: !662, line: 12, type: !35)
!666 = !DILocation(line: 12, column: 42, scope: !661)
!667 = !DILocalVariable(name: "len", arg: 3, scope: !661, file: !662, line: 12, type: !38)
!668 = !DILocation(line: 12, column: 58, scope: !661)
!669 = !DILocalVariable(name: "dest", scope: !661, file: !662, line: 13, type: !64)
!670 = !DILocation(line: 13, column: 9, scope: !661)
!671 = !DILocation(line: 13, column: 16, scope: !661)
!672 = !DILocalVariable(name: "src", scope: !661, file: !662, line: 14, type: !68)
!673 = !DILocation(line: 14, column: 15, scope: !661)
!674 = !DILocation(line: 14, column: 21, scope: !661)
!675 = !DILocation(line: 16, column: 3, scope: !661)
!676 = !DILocation(line: 16, column: 13, scope: !661)
!677 = !DILocation(line: 16, column: 16, scope: !661)
!678 = !DILocation(line: 17, column: 19, scope: !661)
!679 = !DILocation(line: 17, column: 15, scope: !661)
!680 = !DILocation(line: 17, column: 10, scope: !661)
!681 = !DILocation(line: 17, column: 13, scope: !661)
!682 = distinct !{!682, !675, !678}
!683 = !DILocation(line: 18, column: 10, scope: !661)
!684 = !DILocation(line: 18, column: 3, scope: !661)
