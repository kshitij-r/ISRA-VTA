...
entry:
  ...
  call void @llvm.dbg.declare(metadata [9 x i32]* %acc_stage2, metadata !496, metadata !DIExpression()), !dbg !497
...
for.body282:                                      ; preds = %for.cond280
  ...
  %idxprom283 = sext i32 %136 to i64, !dbg !737
  %arrayidx284 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage1, i64 0, i64 %idxprom283, !dbg !737
  %137 = load i32, i32* %arrayidx284, align 4, !dbg !737
  %138 = load i32, i32* %i279, align 4, !dbg !737
  %idxprom285 = sext i32 %138 to i64, !dbg !737
  %arrayidx286 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage2, i64 0, i64 %idxprom285, !dbg !737
  %139 = load i32, i32* %arrayidx286, align 4, !dbg !737
  %cmp287 = icmp eq i32 %137, %139, !dbg !737
  br i1 %cmp287, label %for.inc291, label %cond.false289, !dbg !737

cond.false289:                                    ; preds = %for.body282
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 167, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !737
  unreachable, !dbg !737

for.inc291:                                       ; preds = %for.body282
  %140 = load i32, i32* %i279, align 4, !dbg !739
  %inc292 = add nsw i32 %140, 1, !dbg !739
  store i32 %inc292, i32* %i279, align 4, !dbg !739
  br label %for.cond280, !dbg !740, !llvm.loop !741
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !744 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !750, metadata !DIExpression()), !dbg !751
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !752, metadata !DIExpression()), !dbg !753
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !754, metadata !DIExpression()), !dbg !755
  call void @llvm.dbg.declare(metadata i8** %7, metadata !756, metadata !DIExpression()), !dbg !757
  %9 = load i8*, i8** %4, align 8, !dbg !758
  store i8* %9, i8** %7, align 8, !dbg !757
  call void @llvm.dbg.declare(metadata i8** %8, metadata !759, metadata !DIExpression()), !dbg !760
  %10 = load i8*, i8** %5, align 8, !dbg !761
  store i8* %10, i8** %8, align 8, !dbg !760
  br label %11, !dbg !762

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !763
  %13 = add i64 %12, -1, !dbg !763
  store i64 %13, i64* %6, align 8, !dbg !763
  %14 = icmp ugt i64 %12, 0, !dbg !764
  br i1 %14, label %15, label %21, !dbg !762

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !765
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !765
  store i8* %17, i8** %8, align 8, !dbg !765
  %18 = load i8, i8* %16, align 1, !dbg !766
  %19 = load i8*, i8** %7, align 8, !dbg !767
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !767
  store i8* %20, i8** %7, align 8, !dbg !767
  store i8 %18, i8* %19, align 1, !dbg !768
  br label %11, !dbg !762, !llvm.loop !769

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !770
  ret i8* %22, !dbg !771
}
...
!494 = !DILocalVariable(name: "acc_stage1", scope: !458, file: !3, line: 101, type: !25)
!495 = !DILocation(line: 101, column: 18, scope: !458)
!496 = !DILocalVariable(name: "acc_stage2", scope: !458, file: !3, line: 102, type: !25)
...
!737 = !DILocation(line: 167, column: 10, scope: !738)
!738 = distinct !DILexicalBlock(scope: !734, file: !3, line: 166, column: 33)
!739 = !DILocation(line: 166, column: 29, scope: !734)
!740 = !DILocation(line: 166, column: 5, scope: !734)
!741 = distinct !{!741, !736, !742}
!742 = !DILocation(line: 168, column: 13, scope: !730)
!743 = !DILocation(line: 171, column: 1, scope: !458)
!744 = distinct !DISubprogram(name: "memcpy", scope: !745, file: !745, line: 12, type: !746, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !125, retainedNodes: !4)
!745 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!746 = !DISubroutineType(types: !747)
!747 = !{!35, !35, !36, !748}
!748 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !749, line: 46, baseType: !41)
!749 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!750 = !DILocalVariable(name: "destaddr", arg: 1, scope: !744, file: !745, line: 12, type: !35)
!751 = !DILocation(line: 12, column: 20, scope: !744)
!752 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !744, file: !745, line: 12, type: !36)
!753 = !DILocation(line: 12, column: 42, scope: !744)
!754 = !DILocalVariable(name: "len", arg: 3, scope: !744, file: !745, line: 12, type: !748)
!755 = !DILocation(line: 12, column: 58, scope: !744)
!756 = !DILocalVariable(name: "dest", scope: !744, file: !745, line: 13, type: !65)
!757 = !DILocation(line: 13, column: 9, scope: !744)
!758 = !DILocation(line: 13, column: 16, scope: !744)
!759 = !DILocalVariable(name: "src", scope: !744, file: !745, line: 14, type: !69)
!760 = !DILocation(line: 14, column: 15, scope: !744)
!761 = !DILocation(line: 14, column: 21, scope: !744)
!762 = !DILocation(line: 16, column: 3, scope: !744)
!763 = !DILocation(line: 16, column: 13, scope: !744)
!764 = !DILocation(line: 16, column: 16, scope: !744)
!765 = !DILocation(line: 17, column: 19, scope: !744)
!766 = !DILocation(line: 17, column: 15, scope: !744)
!767 = !DILocation(line: 17, column: 10, scope: !744)
!768 = !DILocation(line: 17, column: 13, scope: !744)
!769 = distinct !{!769, !762, !765}
!770 = !DILocation(line: 18, column: 10, scope: !744)
!771 = !DILocation(line: 18, column: 3, scope: !744)
