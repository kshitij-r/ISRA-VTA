...
if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i32* %i, metadata !695, metadata !DIExpression()), !dbg !698
  store i32 0, i32* %i, align 4, !dbg !698
  br label %for.cond, !dbg !699

for.cond:                                         ; preds = %for.body, %if.then
  %108 = load i32, i32* %i, align 4, !dbg !700
  %cmp238 = icmp slt i32 %108, 9, !dbg !702
  br i1 %cmp238, label %for.body, label %for.end, !dbg !703

for.body:                                         ; preds = %for.cond
  %109 = load i32, i32* %i, align 4, !dbg !704
  %idxprom = sext i32 %109 to i64, !dbg !706
  %arrayidx239 = getelementptr inbounds [9 x %struct.INSTR], [9 x %struct.INSTR]* %microop, i64 0, i64 %idxprom, !dbg !706
  %110 = bitcast %struct.INSTR* %agg.tmp to i8*, !dbg !706
  %111 = bitcast %struct.INSTR* %arrayidx239 to i8*, !dbg !706
  %112 = call i8* @memcpy(i8* %110, i8* %111, i64 40), !dbg !706
  %call = call i32* @_Z13micro_decoder5INSTR(%struct.INSTR* byval(%struct.INSTR) align 8 %agg.tmp), !dbg !707
  store i32* %call, i32** %acc_mem_ref, align 8, !dbg !708
  %113 = load i32*, i32** %acc_mem_ref, align 8, !dbg !709
  %114 = load i32, i32* %i, align 4, !dbg !710
  %idxprom240 = sext i32 %114 to i64, !dbg !709
  %arrayidx241 = getelementptr inbounds i32, i32* %113, i64 %idxprom240, !dbg !709
  %115 = load i32, i32* %arrayidx241, align 4, !dbg !709
  %116 = load i32, i32* %i, align 4, !dbg !711
  %idxprom242 = sext i32 %116 to i64, !dbg !712
  %arrayidx243 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage2, i64 0, i64 %idxprom242, !dbg !712
  store i32 %115, i32* %arrayidx243, align 4, !dbg !713
  %117 = load i32, i32* %i, align 4, !dbg !714
  %inc = add nsw i32 %117, 1, !dbg !714
  store i32 %inc, i32* %i, align 4, !dbg !714
  br label %for.cond, !dbg !715, !llvm.loop !716

for.end:                                          ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i32* %i244, metadata !718, metadata !DIExpression()), !dbg !720
  store i32 0, i32* %i244, align 4, !dbg !720
  br label %for.cond245, !dbg !721

for.cond245:                                      ; preds = %for.body247, %for.end
  %118 = load i32, i32* %i244, align 4, !dbg !722
  %cmp246 = icmp slt i32 %118, 9, !dbg !724
  br i1 %cmp246, label %for.body247, label %if.end, !dbg !725

for.body247:                                      ; preds = %for.cond245
  %119 = load i32, i32* %i244, align 4, !dbg !726
  %idxprom249 = sext i32 %119 to i64, !dbg !728
  %arrayidx250 = getelementptr inbounds [9 x %struct.INSTR_VAL], [9 x %struct.INSTR_VAL]* %microop_val, i64 0, i64 %idxprom249, !dbg !728
  %120 = bitcast %struct.INSTR_VAL* %agg.tmp248 to i8*, !dbg !728
  %121 = bitcast %struct.INSTR_VAL* %arrayidx250 to i8*, !dbg !728
  %122 = call i8* @memcpy(i8* %120, i8* %121, i64 24), !dbg !728
  %call251 = call i32* @_Z17micro_decoder_val9INSTR_VAL(%struct.INSTR_VAL* byval(%struct.INSTR_VAL) align 8 %agg.tmp248), !dbg !729
  store i32* %call251, i32** %acc_mem_val, align 8, !dbg !730
  %123 = load i32*, i32** %acc_mem_val, align 8, !dbg !731
  %124 = load i32, i32* %i244, align 4, !dbg !732
  %idxprom252 = sext i32 %124 to i64, !dbg !731
  %arrayidx253 = getelementptr inbounds i32, i32* %123, i64 %idxprom252, !dbg !731
  %125 = load i32, i32* %arrayidx253, align 4, !dbg !731
  %126 = load i32, i32* %i244, align 4, !dbg !733
  %idxprom254 = sext i32 %126 to i64, !dbg !734
  %arrayidx255 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage3, i64 0, i64 %idxprom254, !dbg !734
  store i32 %125, i32* %arrayidx255, align 4, !dbg !735
  %127 = load i32, i32* %i244, align 4, !dbg !736
  %inc257 = add nsw i32 %127, 1, !dbg !736
  store i32 %inc257, i32* %i244, align 4, !dbg !736
  br label %for.cond245, !dbg !737, !llvm.loop !738
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !741 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !747, metadata !DIExpression()), !dbg !748
  store i8* %1, i8** %5, align 8
  call void @llvm.dbg.declare(metadata i8** %5, metadata !749, metadata !DIExpression()), !dbg !750
  store i64 %2, i64* %6, align 8
  call void @llvm.dbg.declare(metadata i64* %6, metadata !751, metadata !DIExpression()), !dbg !752
  call void @llvm.dbg.declare(metadata i8** %7, metadata !753, metadata !DIExpression()), !dbg !754
  %9 = load i8*, i8** %4, align 8, !dbg !755
  store i8* %9, i8** %7, align 8, !dbg !754
  call void @llvm.dbg.declare(metadata i8** %8, metadata !756, metadata !DIExpression()), !dbg !757
  %10 = load i8*, i8** %5, align 8, !dbg !758
  store i8* %10, i8** %8, align 8, !dbg !757
  br label %11, !dbg !759

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !760
  %13 = add i64 %12, -1, !dbg !760
  store i64 %13, i64* %6, align 8, !dbg !760
  %14 = icmp ugt i64 %12, 0, !dbg !761
  br i1 %14, label %15, label %21, !dbg !759

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !762
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !762
  store i8* %17, i8** %8, align 8, !dbg !762
  %18 = load i8, i8* %16, align 1, !dbg !763
  %19 = load i8*, i8** %7, align 8, !dbg !764
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !764
  store i8* %20, i8** %7, align 8, !dbg !764
  store i8 %18, i8* %19, align 1, !dbg !765
  br label %11, !dbg !759, !llvm.loop !766

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !767
  ret i8* %22, !dbg !768
}
...
!695 = !DILocalVariable(name: "i", scope: !696, file: !3, line: 183, type: !17)
!696 = distinct !DILexicalBlock(scope: !697, file: !3, line: 183, column: 9)
!697 = distinct !DILexicalBlock(scope: !690, file: !3, line: 176, column: 42)
!698 = !DILocation(line: 183, column: 18, scope: !696)
!699 = !DILocation(line: 183, column: 14, scope: !696)
!700 = !DILocation(line: 183, column: 22, scope: !701)
!701 = distinct !DILexicalBlock(scope: !696, file: !3, line: 183, column: 9)
!702 = !DILocation(line: 183, column: 23, scope: !701)
!703 = !DILocation(line: 183, column: 9, scope: !696)
!704 = !DILocation(line: 184, column: 49, scope: !705)
!705 = distinct !DILexicalBlock(scope: !701, file: !3, line: 183, column: 30)
!706 = !DILocation(line: 184, column: 41, scope: !705)
!707 = !DILocation(line: 184, column: 27, scope: !705)
!708 = !DILocation(line: 184, column: 25, scope: !705)
!709 = !DILocation(line: 185, column: 27, scope: !705)
!710 = !DILocation(line: 185, column: 39, scope: !705)
!711 = !DILocation(line: 185, column: 24, scope: !705)
!712 = !DILocation(line: 185, column: 13, scope: !705)
!713 = !DILocation(line: 185, column: 26, scope: !705)
!714 = !DILocation(line: 183, column: 27, scope: !701)
!715 = !DILocation(line: 183, column: 9, scope: !701)
!716 = distinct !{!716, !703, !717}
!717 = !DILocation(line: 186, column: 9, scope: !696)
!718 = !DILocalVariable(name: "i", scope: !719, file: !3, line: 188, type: !17)
!719 = distinct !DILexicalBlock(scope: !697, file: !3, line: 188, column: 9)
!720 = !DILocation(line: 188, column: 18, scope: !719)
!721 = !DILocation(line: 188, column: 14, scope: !719)
!722 = !DILocation(line: 188, column: 22, scope: !723)
!723 = distinct !DILexicalBlock(scope: !719, file: !3, line: 188, column: 9)
!724 = !DILocation(line: 188, column: 23, scope: !723)
!725 = !DILocation(line: 188, column: 9, scope: !719)
!726 = !DILocation(line: 189, column: 57, scope: !727)
!727 = distinct !DILexicalBlock(scope: !723, file: !3, line: 188, column: 30)
!728 = !DILocation(line: 189, column: 45, scope: !727)
!729 = !DILocation(line: 189, column: 27, scope: !727)
!730 = !DILocation(line: 189, column: 25, scope: !727)
!731 = !DILocation(line: 190, column: 27, scope: !727)
!732 = !DILocation(line: 190, column: 39, scope: !727)
!733 = !DILocation(line: 190, column: 24, scope: !727)
!734 = !DILocation(line: 190, column: 13, scope: !727)
!735 = !DILocation(line: 190, column: 26, scope: !727)
!736 = !DILocation(line: 188, column: 27, scope: !723)
!737 = !DILocation(line: 188, column: 9, scope: !723)
!738 = distinct !{!738, !725, !739}
!739 = !DILocation(line: 191, column: 9, scope: !719)
!740 = !DILocation(line: 198, column: 5, scope: !503)
!741 = distinct !DISubprogram(name: "memcpy", scope: !742, file: !742, line: 12, type: !743, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !126, retainedNodes: !4)
!742 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!743 = !DISubroutineType(types: !744)
!744 = !{!40, !40, !41, !745}
!745 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !746, line: 46, baseType: !45)
!746 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!747 = !DILocalVariable(name: "destaddr", arg: 1, scope: !741, file: !742, line: 12, type: !40)
!748 = !DILocation(line: 12, column: 20, scope: !741)
!749 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !741, file: !742, line: 12, type: !41)
!750 = !DILocation(line: 12, column: 42, scope: !741)
!751 = !DILocalVariable(name: "len", arg: 3, scope: !741, file: !742, line: 12, type: !745)
!752 = !DILocation(line: 12, column: 58, scope: !741)
!753 = !DILocalVariable(name: "dest", scope: !741, file: !742, line: 13, type: !69)
!754 = !DILocation(line: 13, column: 9, scope: !741)
!755 = !DILocation(line: 13, column: 16, scope: !741)
!756 = !DILocalVariable(name: "src", scope: !741, file: !742, line: 14, type: !73)
!757 = !DILocation(line: 14, column: 15, scope: !741)
!758 = !DILocation(line: 14, column: 21, scope: !741)
!759 = !DILocation(line: 16, column: 3, scope: !741)
!760 = !DILocation(line: 16, column: 13, scope: !741)
!761 = !DILocation(line: 16, column: 16, scope: !741)
!762 = !DILocation(line: 17, column: 19, scope: !741)
!763 = !DILocation(line: 17, column: 15, scope: !741)
!764 = !DILocation(line: 17, column: 10, scope: !741)
!765 = !DILocation(line: 17, column: 13, scope: !741)
!766 = distinct !{!766, !759, !762}
!767 = !DILocation(line: 18, column: 10, scope: !741)
!768 = !DILocation(line: 18, column: 3, scope: !741)
