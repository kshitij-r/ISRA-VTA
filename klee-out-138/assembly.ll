...
cond.false289:                                    ; preds = %for.body282
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 167, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !744
  unreachable, !dbg !744
...
!737 = !DILocation(line: 167, column: 42, scope: !738)
!738 = distinct !DILexicalBlock(scope: !734, file: !3, line: 166, column: 39)
!739 = !DILocation(line: 167, column: 31, scope: !738)
!740 = !DILocation(line: 167, column: 59, scope: !738)
!741 = !DILocation(line: 167, column: 48, scope: !738)
!742 = !DILocation(line: 167, column: 45, scope: !738)
!743 = !DILocation(line: 167, column: 11, scope: !738)
!744 = !DILocation(line: 167, column: 76, scope: !738)
