...
entry:
  ...
  %i = alloca i32, align 4
  %agg.tmp = alloca %struct.INSTR_VAL, align 8
...
for.cond:                                         ; preds = %for.body, %if.then
  ...
  br i1 %cmp238, label %for.body, label %if.end, !dbg !703

for.body:                                         ; preds = %for.cond
  %109 = load i32, i32* %i, align 4, !dbg !704
  %idxprom = sext i32 %109 to i64, !dbg !706
  %arrayidx239 = getelementptr inbounds [9 x %struct.INSTR_VAL], [9 x %struct.INSTR_VAL]* %microop_val, i64 0, i64 %idxprom, !dbg !706
  %110 = bitcast %struct.INSTR_VAL* %agg.tmp to i8*, !dbg !706
  %111 = bitcast %struct.INSTR_VAL* %arrayidx239 to i8*, !dbg !706
  %112 = call i8* @memcpy(i8* %110, i8* %111, i64 24), !dbg !706
  %call = call i32* @_Z17micro_decoder_val9INSTR_VAL(%struct.INSTR_VAL* byval(%struct.INSTR_VAL) align 8 %agg.tmp), !dbg !707
  store i32* %call, i32** %acc_mem_val, align 8, !dbg !708
  %113 = load i32*, i32** %acc_mem_val, align 8, !dbg !709
  ...
  %arrayidx243 = getelementptr inbounds [9 x i32], [9 x i32]* %acc_stage3, i64 0, i64 %idxprom242, !dbg !712
...
; Function Attrs: noinline nounwind uwtable
define dso_local i8* @memcpy(i8*, i8*, i64) #0 !dbg !719 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  ...
  call void @llvm.dbg.declare(metadata i8** %4, metadata !725, metadata !DIExpression()), !dbg !726
  ...
  call void @llvm.dbg.declare(metadata i8** %7, metadata !731, metadata !DIExpression()), !dbg !732
  %9 = load i8*, i8** %4, align 8, !dbg !733
  store i8* %9, i8** %7, align 8, !dbg !732
  call void @llvm.dbg.declare(metadata i8** %8, metadata !734, metadata !DIExpression()), !dbg !735
  %10 = load i8*, i8** %5, align 8, !dbg !736
  store i8* %10, i8** %8, align 8, !dbg !735
  br label %11, !dbg !737

11:                                               ; preds = %15, %3
  %12 = load i64, i64* %6, align 8, !dbg !738
  %13 = add i64 %12, -1, !dbg !738
  store i64 %13, i64* %6, align 8, !dbg !738
  %14 = icmp ugt i64 %12, 0, !dbg !739
  br i1 %14, label %15, label %21, !dbg !737

15:                                               ; preds = %11
  %16 = load i8*, i8** %8, align 8, !dbg !740
  %17 = getelementptr inbounds i8, i8* %16, i32 1, !dbg !740
  store i8* %17, i8** %8, align 8, !dbg !740
  %18 = load i8, i8* %16, align 1, !dbg !741
  %19 = load i8*, i8** %7, align 8, !dbg !742
  %20 = getelementptr inbounds i8, i8* %19, i32 1, !dbg !742
  store i8* %20, i8** %7, align 8, !dbg !742
  store i8 %18, i8* %19, align 1, !dbg !743
  br label %11, !dbg !737, !llvm.loop !744

21:                                               ; preds = %11
  %22 = load i8*, i8** %4, align 8, !dbg !745
  ret i8* %22, !dbg !746
}
...
!695 = !DILocalVariable(name: "i", scope: !696, file: !3, line: 188, type: !17)
...
!698 = !DILocation(line: 188, column: 18, scope: !696)
!699 = !DILocation(line: 188, column: 14, scope: !696)
!700 = !DILocation(line: 188, column: 22, scope: !701)
!701 = distinct !DILexicalBlock(scope: !696, file: !3, line: 188, column: 9)
!702 = !DILocation(line: 188, column: 23, scope: !701)
!703 = !DILocation(line: 188, column: 9, scope: !696)
!704 = !DILocation(line: 189, column: 57, scope: !705)
!705 = distinct !DILexicalBlock(scope: !701, file: !3, line: 188, column: 30)
!706 = !DILocation(line: 189, column: 45, scope: !705)
!707 = !DILocation(line: 189, column: 27, scope: !705)
!708 = !DILocation(line: 189, column: 25, scope: !705)
!709 = !DILocation(line: 190, column: 27, scope: !705)
!710 = !DILocation(line: 190, column: 39, scope: !705)
!711 = !DILocation(line: 190, column: 24, scope: !705)
!712 = !DILocation(line: 190, column: 13, scope: !705)
!713 = !DILocation(line: 190, column: 26, scope: !705)
!714 = !DILocation(line: 188, column: 27, scope: !701)
!715 = !DILocation(line: 188, column: 9, scope: !701)
!716 = distinct !{!716, !703, !717}
!717 = !DILocation(line: 191, column: 9, scope: !696)
!718 = !DILocation(line: 198, column: 5, scope: !503)
!719 = distinct !DISubprogram(name: "memcpy", scope: !720, file: !720, line: 12, type: !721, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !126, retainedNodes: !4)
!720 = !DIFile(filename: "klee_src/runtime/Freestanding/memcpy.c", directory: "/tmp")
!721 = !DISubroutineType(types: !722)
!722 = !{!40, !40, !41, !723}
!723 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !724, line: 46, baseType: !45)
!724 = !DIFile(filename: "/usr/lib/llvm-9/lib/clang/9.0.0/include/stddef.h", directory: "")
!725 = !DILocalVariable(name: "destaddr", arg: 1, scope: !719, file: !720, line: 12, type: !40)
!726 = !DILocation(line: 12, column: 20, scope: !719)
!727 = !DILocalVariable(name: "srcaddr", arg: 2, scope: !719, file: !720, line: 12, type: !41)
!728 = !DILocation(line: 12, column: 42, scope: !719)
!729 = !DILocalVariable(name: "len", arg: 3, scope: !719, file: !720, line: 12, type: !723)
!730 = !DILocation(line: 12, column: 58, scope: !719)
!731 = !DILocalVariable(name: "dest", scope: !719, file: !720, line: 13, type: !69)
!732 = !DILocation(line: 13, column: 9, scope: !719)
!733 = !DILocation(line: 13, column: 16, scope: !719)
!734 = !DILocalVariable(name: "src", scope: !719, file: !720, line: 14, type: !73)
!735 = !DILocation(line: 14, column: 15, scope: !719)
!736 = !DILocation(line: 14, column: 21, scope: !719)
!737 = !DILocation(line: 16, column: 3, scope: !719)
!738 = !DILocation(line: 16, column: 13, scope: !719)
!739 = !DILocation(line: 16, column: 16, scope: !719)
!740 = !DILocation(line: 17, column: 19, scope: !719)
!741 = !DILocation(line: 17, column: 15, scope: !719)
!742 = !DILocation(line: 17, column: 10, scope: !719)
!743 = !DILocation(line: 17, column: 13, scope: !719)
!744 = distinct !{!744, !737, !740}
!745 = !DILocation(line: 18, column: 10, scope: !719)
!746 = !DILocation(line: 18, column: 3, scope: !719)
