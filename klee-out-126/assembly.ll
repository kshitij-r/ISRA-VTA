...
for.body262:                                      ; preds = %for.cond260
  ...
  %125 = load i32*, i32** %acc_mem_ref, align 8, !dbg !707
...
cond.false:                                       ; preds = %for.body262
  call void @__assert_fail(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 159, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #6, !dbg !707
  unreachable, !dbg !707
...
!699 = !DILocalVariable(name: "i", scope: !700, file: !3, line: 158, type: !38)
!700 = distinct !DILexicalBlock(scope: !666, file: !3, line: 158, column: 9)
!701 = !DILocation(line: 158, column: 18, scope: !700)
!702 = !DILocation(line: 158, column: 14, scope: !700)
!703 = !DILocation(line: 158, column: 25, scope: !704)
!704 = distinct !DILexicalBlock(scope: !700, file: !3, line: 158, column: 9)
!705 = !DILocation(line: 158, column: 27, scope: !704)
!706 = !DILocation(line: 158, column: 9, scope: !700)
!707 = !DILocation(line: 159, column: 10, scope: !708)
!708 = distinct !DILexicalBlock(scope: !704, file: !3, line: 158, column: 43)
!709 = !DILocation(line: 158, column: 39, scope: !704)
!710 = !DILocation(line: 158, column: 9, scope: !704)
!711 = distinct !{!711, !706, !712}
!712 = !DILocation(line: 160, column: 13, scope: !700)
